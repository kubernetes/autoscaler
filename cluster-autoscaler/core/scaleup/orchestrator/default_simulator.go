...
func (s *DefaultSimulator) Simulate(
	...
	validNodeGroups, skippedNodeGroups := s.orchestrator.filterValidScaleUpNodeGroups(nodeGroups, nodeInfos, tracker, len(nodes), now)
	...
	return options, skippedNodeGroups, schedulablePodGroups, nil
}
