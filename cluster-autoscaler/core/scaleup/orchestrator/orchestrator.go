...
func (o *ScaleUpOrchestrator) ComputeExpansionOption(
	...
	pods := schedulablePodGroups[nodeGroup.Id()]
...
func (o *ScaleUpOrchestrator) ComputeSimilarNodeGroups(
	...
	for _, ng := range similarNodeGroups {
		...
		} else if similarPodGroups, found := schedulablePodGroups[ng.Id()]; found && matchingSchedulablePods(podGroups, similarPodGroups) {
...
func matchingSchedulablePods(podGroups []estimator.PodEquivalenceGroup, similarPodGroups []estimator.PodEquivalenceGroup) bool {
