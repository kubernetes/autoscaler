...
func (e Evictor) DrainNode(ctx *ca_context.AutoscalingContext, nodeInfo *framework.NodeInfo) (map[string]status.PodEvictionResult, error) {
...
func (e Evictor) drainNodeForce(ctx *ca_context.AutoscalingContext, nodeInfo *framework.NodeInfo) (map[string]status.PodEvictionResult, error) {
...
func forceDeletePod(ctx *ca_context.AutoscalingContext, pod *apiv1.Pod) error {
