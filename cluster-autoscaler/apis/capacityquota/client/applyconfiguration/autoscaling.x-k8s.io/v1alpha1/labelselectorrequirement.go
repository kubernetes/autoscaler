...
type LabelSelectorRequirementApplyConfiguration struct {
	...
	Operator *autoscalingxk8siov1alpha1.LabelSelectorOperator `json:"operator,omitempty"`
...
func (b *LabelSelectorRequirementApplyConfiguration) WithOperator(value autoscalingxk8siov1alpha1.LabelSelectorOperator) *LabelSelectorRequirementApplyConfiguration {
	b.Operator = &value
	return b
}
