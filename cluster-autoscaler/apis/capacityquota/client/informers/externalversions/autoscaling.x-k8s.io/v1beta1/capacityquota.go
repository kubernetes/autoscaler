...
import (
	...
	capacityquotaautoscalingxk8siov1beta1 "k8s.io/autoscaler/cluster-autoscaler/apis/capacityquota/autoscaling.x-k8s.io/v1beta1"
	...
	autoscalingxk8siov1beta1 "k8s.io/autoscaler/cluster-autoscaler/apis/capacityquota/client/listers/autoscaling.x-k8s.io/v1beta1"
	...
	return cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				...
				return client.AutoscalingV1beta1().CapacityQuotas(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AutoscalingV1beta1().CapacityQuotas(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AutoscalingV1beta1().CapacityQuotas(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AutoscalingV1beta1().CapacityQuotas(namespace).Watch(ctx, opts)
			},
		}, client),
		&capacityquotaautoscalingxk8siov1beta1.CapacityQuota{},
