...
type CapacityBufferLister interface {
	...
	List(selector labels.Selector) (ret []*autoscalingxk8siov1beta1.CapacityBuffer, err error)
...
type capacityBufferLister struct {
	listers.ResourceIndexer[*autoscalingxk8siov1beta1.CapacityBuffer]
}
...
func NewCapacityBufferLister(indexer cache.Indexer) CapacityBufferLister {
	return &capacityBufferLister{listers.New[*autoscalingxk8siov1beta1.CapacityBuffer](indexer, autoscalingxk8siov1beta1.Resource("capacitybuffer"))}
}

// CapacityBuffers returns an object that can list and get CapacityBuffers.
func (s *capacityBufferLister) CapacityBuffers(namespace string) CapacityBufferNamespaceLister {
	return capacityBufferNamespaceLister{listers.NewNamespaced[*autoscalingxk8siov1beta1.CapacityBuffer](s.ResourceIndexer, namespace)}
}
...
type CapacityBufferNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*autoscalingxk8siov1beta1.CapacityBuffer, error)
