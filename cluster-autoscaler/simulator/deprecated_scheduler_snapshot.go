...
// This file contains copies of snapshot related code from scheduler codebase.
// It is temporary measure to make thinks compiling in the intermediate state and gets removed a couple commits later
