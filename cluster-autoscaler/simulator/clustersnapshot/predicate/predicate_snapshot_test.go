...
func validTestCases(t *testing.T, snapshotName string) []modificationTestCase {
	...
	nodeAllocResourceSlice := &resourceapi.ResourceSlice{
		...
		Spec: resourceapi.ResourceSliceSpec{
			...
			Devices: []resourceapi.Device{{
				Name: "dev-cpu",
				NodeAllocatableResourceMappings: map[apiv1.ResourceName]resourceapi.NodeAllocatableResourceMapping{
					apiv1.ResourceCPU: {AllocationMultiplier: ptr.To(resource.MustParse("1m"))},
				},
			}},
		},
	}
	...
	scheduledPodWithNodeAllocClaim.Status.NodeAllocatableResourceClaimStatuses = []apiv1.NodeAllocatableResourceClaimStatus{
		{
			...
			Resources:         apiv1.ResourceList{apiv1.ResourceCPU: resource.MustParse("1m")},
		},
	}
