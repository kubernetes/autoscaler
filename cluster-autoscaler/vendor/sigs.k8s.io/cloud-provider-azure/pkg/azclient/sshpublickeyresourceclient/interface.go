...
// +azure:client:verbs=get;listbyrg,resource=SSHPublicKeyResource,packageName=github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/compute/armcompute/v7,packageAlias=armcompute,clientName=SSHPublicKeysClient,expand=false
