...
func (client *Client) Get(ctx context.Context, resourceGroupName string, resourceName string, expand *armcompute.ExpandTypesForGetVMScaleSets) (result *armcompute.VirtualMachineScaleSet, rerr error) {
	var ops *armcompute.VirtualMachineScaleSetsClientGetOptions
	if expand != nil {
		ops = &armcompute.VirtualMachineScaleSetsClientGetOptions{Expand: expand}
	}
