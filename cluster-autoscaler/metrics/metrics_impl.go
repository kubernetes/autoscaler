...
func newCaMetricsImplWithRegistry(registry metrics.KubeRegistry) *caMetricsImpl {
	reg := newCaMetricsImpl()
	reg.registry = registry
	return reg
}

func newCaMetricsImpl() *caMetricsImpl {
	return &caMetricsImpl{
...
func (m *caMetricsImpl) mustRegister(cs ...k8smetrics.Registerable) {
	if m.registry != nil {
...
func (m *caMetricsImpl) RegisterAll(emitPerNodeGroupMetrics bool) {
...
func (m *caMetricsImpl) InitMetrics() {
...
func (m *caMetricsImpl) UpdateDurationFromStart(label FunctionLabel, start time.Time) {
	duration := time.Now().Sub(start)
	m.UpdateDuration(label, duration)
}

// UpdateDuration records the duration of the step identified by the label
func (m *caMetricsImpl) UpdateDuration(label FunctionLabel, duration time.Duration) {
...
func (m *caMetricsImpl) UpdateLastTime(label FunctionLabel, now time.Time) {
...
func (m *caMetricsImpl) UpdateClusterSafeToAutoscale(safe bool) {
	if safe {
...
func (m *caMetricsImpl) UpdateNodesCount(ready, unready, starting, longUnregistered, unregistered int) {
...
func (m *caMetricsImpl) UpdateNodeGroupsCount(autoscaled, autoprovisioned int) {
...
func (m *caMetricsImpl) UpdateUnschedulablePodsCount(uschedulablePodsCount, schedulerUnprocessedCount int) {
...
func (m *caMetricsImpl) UpdateUnschedulablePodsCountWithLabel(uschedulablePodsCount int, label string) {
...
func (m *caMetricsImpl) UpdateMaxNodesCount(nodesCount int) {
...
func (m *caMetricsImpl) UpdateClusterCPUCurrentCores(coresCount int64) {
...
func (m *caMetricsImpl) UpdateCPULimitsCores(minCoresCount int64, maxCoresCount int64) {
...
func (m *caMetricsImpl) UpdateClusterMemoryCurrentBytes(memoryCount int64) {
...
func (m *caMetricsImpl) UpdateMemoryLimitsBytes(minMemoryCount int64, maxMemoryCount int64) {
...
func (m *caMetricsImpl) UpdateNodeGroupMin(nodeGroup string, minNodes int) {
...
func (m *caMetricsImpl) UpdateNodeGroupMax(nodeGroup string, maxNodes int) {
...
func (m *caMetricsImpl) UpdateNodeGroupTargetSize(targetSizes map[string]int) {
...
func (m *caMetricsImpl) UpdateNodeGroupHealthStatus(nodeGroup string, healthy bool) {
	if healthy {
...
func (m *caMetricsImpl) UpdateNodeGroupBackOffStatus(nodeGroup string, backoffReasonStatus map[string]bool) {
...
func (m *caMetricsImpl) RegisterError(err errors.AutoscalerError) {
	m.errorsCount.WithLabelValues(string(err.Type())).Add(1.0)
}

// RegisterScaleUp records number of nodes added by scale up
func (m *caMetricsImpl) RegisterScaleUp(nodesCount int, gpuResourceName, gpuType string) {
...
func (m *caMetricsImpl) RegisterFailedScaleUp(reason FailedScaleUpReason, gpuResourceName, gpuType string) {
...
func (m *caMetricsImpl) RegisterScaleDown(nodesCount int, gpuResourceName, gpuType string, reason NodeScaleDownReason) {
...
func (m *caMetricsImpl) RegisterEvictions(podsCount int, result PodEvictionResult) {
...
func (m *caMetricsImpl) UpdateUnneededNodesCount(nodesCount int) {
	m.unneededNodesCount.Set(float64(nodesCount))
}

// UpdateUnremovableNodesCount records number of currently unremovable nodes
func (m *caMetricsImpl) UpdateUnremovableNodesCount(unremovableReasonCounts map[simulator.UnremovableReason]int) {
...
func (m *caMetricsImpl) RegisterNodeGroupCreation() {
...
func (m *caMetricsImpl) RegisterNodeGroupCreationWithLabelValues(groupType string) {
	m.nodeGroupCreationCount.WithLabelValues(groupType).Add(1.0)
}

// RegisterNodeGroupDeletion registers node group deletion
func (m *caMetricsImpl) RegisterNodeGroupDeletion() {
...
func (m *caMetricsImpl) RegisterNodeGroupDeletionWithLabelValues(groupType string) {
...
func (m *caMetricsImpl) UpdateScaleDownInCooldown(inCooldown bool) {
	if inCooldown {
...
func (m *caMetricsImpl) RegisterOldUnregisteredNodesRemoved(nodesCount int) {
...
func (m *caMetricsImpl) UpdateOverflowingControllers(count int) {
...
func (m *caMetricsImpl) RegisterSkippedScaleDownCPU() {
...
func (m *caMetricsImpl) RegisterSkippedScaleDownMemory() {
...
func (m *caMetricsImpl) RegisterSkippedScaleUpCPU() {
...
func (m *caMetricsImpl) RegisterSkippedScaleUpMemory() {
...
func (m *caMetricsImpl) ObservePendingNodeDeletions(value int) {
	m.pendingNodeDeletions.Set(float64(value))
}

// ObserveNodeTaintsCount records the node taints count of given type.
func (m *caMetricsImpl) ObserveNodeTaintsCount(taintType string, count float64) {
...
func (m *caMetricsImpl) UpdateInconsistentInstancesMigsCount(migCount int) {
...
func (m *caMetricsImpl) ObserveBinpackingHeterogeneity(instanceType, cpuCount, namespaceCount string, pegCount int) {
...
func (m *caMetricsImpl) UpdateScaleDownNodeRemovalLatency(deleted bool, duration time.Duration) {
...
func (m *caMetricsImpl) ObserveMaxNodeSkipEvalDurationSeconds(duration time.Duration) {
