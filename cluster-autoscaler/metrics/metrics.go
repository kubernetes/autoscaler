...
type CAMetricsRegistry interface {
	...
	UpdateNodesCount(ready, unready, starting, suspended, longUnregistered, unregistered int)
	...
	RegisterScaleUp(nodesCount int, gpuResourceName, gpuType, draDrivers string)

	// RegisterFailedScaleUp records a failed scale-up operation
	RegisterFailedScaleUp(reason FailedScaleUpReason, gpuResourceName, gpuType, draDrivers string)
	...
	RegisterScaleDown(nodesCount int, gpuResourceName, gpuType string, reason NodeScaleDownReason, draDrivers string)
