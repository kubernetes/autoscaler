...
Example exection looks like this:
```
...
Caveats:
 ...
 - `update-vendor.sh` automatically runs unit tests as part of verification process. If one needs to supress that, it can be done by overriding `VERIFY_COMMAND` variable (`VERIFY_COMMAND=true ./hack/update-vendor.sh ...`) 
