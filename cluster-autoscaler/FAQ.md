...
| `leader-elect-resource-lock` | The type of resource object that is used for locking during leader election. Supported options are 'leases', 'endpointsleases' and 'configmapsleases'. | "leases" |
...
| `parallel-drain` | Whether to allow parallel drain of nodes. This flag is deprecated and will be removed in future releases. | true |
