...
type Interface interface {
	GetDaemonSetPodsFromPodTemplateForNode(baseNodeInfo *schedulerframework.NodeInfo, predicateChecker simulator.PredicateChecker, ignoredTaints taints.TaintKeySet) ([]*apiv1.Pod, error)
	CleanUp()
}
...
func (p *podTemplateProcessor) GetDaemonSetPodsFromPodTemplateForNode(baseNodeInfo *schedulerframework.NodeInfo, predicateChecker simulator.PredicateChecker, ignoredTaints taints.TaintKeySet) ([]*apiv1.Pod, error) {
...
func (p *dummyPodTemplateProcessor) GetDaemonSetPodsFromPodTemplateForNode(baseNodeInfo *schedulerframework.NodeInfo, predicateChecker simulator.PredicateChecker, ignoredTaints taints.TaintKeySet) ([]*apiv1.Pod, error) {
	return nil, nil
}
