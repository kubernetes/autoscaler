...
func areResourcePoolsReady(resourceSlices []*v1beta1.ResourceSlice, templateNodeResourcesSlices []*v1beta1.ResourceSlice) bool {
...
func getCompleteResourcePools(resourceSlices []*v1beta1.ResourceSlice) map[string]int {
