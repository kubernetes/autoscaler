...
const (
	NvidiaDriverName    = gpu.ResourceNvidiaGPU
	SomeOtherDriverName = "Driver1"
	AnotherDriverName   = "Driver2"
)

var (
	node1Slice1 = &resourceapi.ResourceSlice{ObjectMeta: metav1.ObjectMeta{Name: "local-slice-1", UID: "local-slice-1"}, Spec: resourceapi.ResourceSliceSpec{NodeName: "node1", Driver: NvidiaDriverName}}
	node1Slice2 = &resourceapi.ResourceSlice{ObjectMeta: metav1.ObjectMeta{Name: "local-slice-2", UID: "local-slice-2"}, Spec: resourceapi.ResourceSliceSpec{NodeName: "node1", Driver: SomeOtherDriverName}}
	node2Slice1 = &resourceapi.ResourceSlice{ObjectMeta: metav1.ObjectMeta{Name: "local-slice-3", UID: "local-slice-3"}, Spec: resourceapi.ResourceSliceSpec{NodeName: "node2", Driver: gpu.ResourceNvidiaGPU}}
	node2Slice2 = &resourceapi.ResourceSlice{ObjectMeta: metav1.ObjectMeta{Name: "local-slice-4", UID: "local-slice-4"}, Spec: resourceapi.ResourceSliceSpec{NodeName: "node2", Driver: AnotherDriverName}}
	node3Slice1 = &resourceapi.ResourceSlice{ObjectMeta: metav1.ObjectMeta{Name: "local-slice-5", UID: "local-slice-5"}, Spec: resourceapi.ResourceSliceSpec{NodeName: "node3", Driver: SomeOtherDriverName}}
	node3Slice2 = &resourceapi.ResourceSlice{ObjectMeta: metav1.ObjectMeta{Name: "local-slice-6", UID: "local-slice-6"}, Spec: resourceapi.ResourceSliceSpec{NodeName: "node3", Driver: AnotherDriverName}}
)
...
func TestFilterOutNodesWithUnreadyDRAResources(t *testing.T) {
	...
	nodeDraUnready.Status.Allocatable[SomeOtherDriverName] = *resource.NewQuantity(1, resource.DecimalSI)
	nodeDraUnready.Status.Capacity[NvidiaDriverName] = *resource.NewQuantity(0, resource.DecimalSI)
	nodeDraUnready.Status.Capacity[SomeOtherDriverName] = *resource.NewQuantity(1, resource.DecimalSI)
	...
	localSlices := map[string][]*resourceapi.ResourceSlice{
		...
		"node_2_Dra_Unready":  {node2Slice1, node2Slice2},
