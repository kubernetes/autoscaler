...
// CombinedScaleDownCandidatesProcessor is a structure for containing the individual
// scale down processors that are used by the core autoscaler during its scale down process.
