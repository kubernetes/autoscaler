...
type AutoscalingProcessors struct {
	...
	// NodeInfoProviderProcessor is used to create the initial nodeInfos set.
	NodeInfoProviderProcessor nodeinfosprovider.NodeInfoProviderProcessor
...
func DefaultProcessors() *AutoscalingProcessors {
	return &AutoscalingProcessors{
		...
		NodeInfoProviderProcessor:  nodeinfosprovider.NewDefaultNodeInfoProviderProcessor(),
	}
}
...
func (ap *AutoscalingProcessors) CleanUp() {
	...
	ap.NodeInfoProviderProcessor.CleanUp()
}
