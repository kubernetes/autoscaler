...
func TestWaitForOp(t *testing.T) {
	...
	err := g.WaitForOperation(context.TODO(), "operation-1505728466148-d16f5197", "TestWaitForOp", projectId, zoneB)
...
func TestWaitForOpError(t *testing.T) {
	...
	err := g.WaitForOperation(context.TODO(), "operation-1505728466148-d16f5197", "TestWaitForOpError", projectId, zoneB)
	assert.Error(t, err)
	mock.AssertExpectationsForObjects(t, server)
}
...
func TestWaitForOpTimeout(t *testing.T) {
	...
	err := g.WaitForOperation(context.TODO(), "operation-1505728466148-d16f5197", "TestWaitForOpTimeout", projectId, zoneB)
	assert.Error(t, err)
	mock.AssertExpectationsForObjects(t, server)
}
...
func TestWaitForOpContextTimeout(t *testing.T) {
	...
	err := g.WaitForOperation(context.TODO(), "operation-1505728466148-d16f5197", "TestWaitForOpContextTimeout", projectId, zoneB)
...
func TestErrors(t *testing.T) {
	...
	for _, tc := range testCases {
		for _, errorCode := range tc.errorCodes {
			...
			instances, err := g.FetchMigInstances(context.TODO(), GceRef{})
			assert.NoError(t, err)
...
func TestFetchMigInstancesInstanceUrlHandling(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			gotInstances, err := g.FetchMigInstances(context.TODO(), GceRef{})
			assert.NoError(t, err)
...
func TestFetchAvailableDiskTypes(t *testing.T) {
	...
	t.Run("correctly parse a response", func(t *testing.T) {
		...
		got, err := g.FetchAvailableDiskTypes(context.TODO(), "us-central1-b")
...
func TestUserAgent(t *testing.T) {
	...
	err := g.WaitForOperation(context.TODO(), "operation-1505728466148-d16f5197", "TestUserAgent", projectId, zoneB)
...
func TestAutoscalingClientTimeouts(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"CreateInstances_ContextTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.CreateInstances(context.TODO(), GceRef{}, "", 0, nil)
				return err
			},
		...
		"DeleteInstances_ContextTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				return client.DeleteInstances(context.TODO(), GceRef{}, nil)
			},
			operationPerCallTimeout: &instantTimeout,
		},
		"ResizeMig_ContextTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				return client.ResizeMig(context.TODO(), GceRef{}, 0)
			},
			operationPerCallTimeout: &instantTimeout,
		},
		"FetchMachineType_ContextTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchMachineType(context.TODO(), "", "")
				return err
			},
			operationPerCallTimeout: &instantTimeout,
		},
		"FetchMigBasename_ContextTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchMigBasename(context.TODO(), GceRef{})
				return err
			},
			operationPerCallTimeout: &instantTimeout,
		},
		"FetchMigTargetSize_ContextTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchMigTargetSize(context.TODO(), GceRef{})
				return err
			},
			operationPerCallTimeout: &instantTimeout,
		},
		"FetchMigTemplate_ContextTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchMigTemplate(context.TODO(), GceRef{}, "", false)
				return err
			},
			operationPerCallTimeout: &instantTimeout,
		},
		"FetchMigTemplateName_ContextTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchMigTemplateName(context.TODO(), GceRef{})
				return err
			},
			operationPerCallTimeout: &instantTimeout,
		},
		"FetchListManagedInstancesResults_ContextTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchListManagedInstancesResults(context.TODO(), GceRef{})
				return err
			},
			operationPerCallTimeout: &instantTimeout,
		},
		"FetchZones_ContextTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchZones(context.TODO(), "")
				return err
			},
			operationPerCallTimeout: &instantTimeout,
		},
		...
		"FetchMachineTypes_HttpClientTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchMachineTypes(context.TODO(), "")
				return err
			},
			httpTimeout: instantTimeout,
		},
		"FetchAllMigs_HttpClientTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchAllMigs(context.TODO(), "")
				return err
			},
			httpTimeout: instantTimeout,
		},
		"FetchMigInstances_HttpClientTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchMigInstances(context.TODO(), GceRef{})
				return err
			},
			httpTimeout: instantTimeout,
		},
		"FetchAvailableCpuPlatforms_HttpClientTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchAvailableCpuPlatforms(context.TODO())
				return err
			},
			httpTimeout: instantTimeout,
		},
		"FetchAvailableDiskTypes_HttpClientTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchAvailableDiskTypes(context.TODO(), "")
				return err
			},
			httpTimeout: instantTimeout,
		},
		"FetchMigsWithName_HttpClientTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchMigsWithName(context.TODO(), "", &regexp.Regexp{})
				return err
			},
			httpTimeout: instantTimeout,
		},
		"FetchReservationsInProject_HttpClientTimeout": {
			clientFunc: func(client *autoscalingGceClientV1) error {
				_, err := client.FetchReservationsInProject(context.TODO(), "")
				return err
			},
			httpTimeout: instantTimeout,
		},
	...
	server := test_util.NewHttpServerMock()
	defer server.Close()
	server.On("handle", context.TODO()).Return(`{"status": "unreachable"}`).After(50 * time.Millisecond)
...
func TestCreateInstances(t *testing.T) {
	...
	createdIds, err := client.CreateInstances(context.TODO(), migRef, migRef.Name, 10, nil)
	assert.NoError(t, err)
...
func TestFetchAllInstances(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := gceInternalService.FetchAllInstances(context.TODO(), "myprojid", "myzone", "test-cluster")
...
func TestFetchMigTargetSize(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			size, err := gceClient.FetchMigTargetSize(context.TODO(), mig)
			assert.NoError(t, err)
