			...
			wantInstances: []GceInstance{
				{
					...
					NumericId:        2,
					InstanceTemplate: fmt.Sprintf(instanceTemplateNameTempl, 2),
				},
				{
					Instance: cloudprovider.Instance{
					...
					NumericId:        42,
					InstanceTemplate: fmt.Sprintf(instanceTemplateNameTempl, 42),
				},
			},
		},
		{
			...
			wantInstances: []GceInstance{
				...
				},
				{
					...
					NumericId:        123,
					InstanceTemplate: fmt.Sprintf(instanceTemplateNameTempl, 127),
				},
				{
					Instance: cloudprovider.Instance{
					...
					NumericId:        456,
					InstanceTemplate: fmt.Sprintf(instanceTemplateNameTempl, 17),
				},
			},
		},
		{
