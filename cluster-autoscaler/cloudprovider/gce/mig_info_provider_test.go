...
func (client *mockAutoscalingGceClient) FetchMachineTypes(ctx context.Context, _ string) ([]*gce.MachineType, error) {
	return nil, nil
}

func (client *mockAutoscalingGceClient) FetchAllMigs(ctx context.Context, zone string) ([]*gce.InstanceGroupManager, error) {
...
func (client *mockAutoscalingGceClient) FetchAvailableCpuPlatforms(ctx context.Context) (map[string][]string, error) {
	return nil, nil
}

func (client *mockAutoscalingGceClient) FetchAvailableDiskTypes(ctx context.Context, _ string) ([]string, error) {
	return nil, nil
}

func (client *mockAutoscalingGceClient) FetchReservations(ctx context.Context) ([]*gce.Reservation, error) {
	return nil, nil
}

func (client *mockAutoscalingGceClient) FetchReservationsInProject(ctx context.Context, _ string) ([]*gce.Reservation, error) {
	return nil, nil
}
...
func TestFillMigInstances(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			assert.NoError(t, provider.fillMigInstances(context.TODO(), migRef))
			assert.Equal(t, tc.wantClientCalls, callCounter[migRef])

			updateTime, updateTimeFound := tc.cache.GetMigInstancesUpdateTime(context.TODO(), migRef)
			assert.True(t, updateTimeFound)
			assert.Equal(t, tc.wantUpdateTime, updateTime)

			instances, instancesFound := tc.cache.GetMigInstances(context.TODO(), migRef)
...
func TestMigInfoProviderGetMigForInstance(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			mig, err := provider.GetMigForInstance(context.TODO(), instanceRef)

			cachedMigRef, cached := tc.cache.GetMigForInstance(context.TODO(), instanceRef)
			cachedMigUnknown := tc.cache.IsMigUnknownForInstance(context.TODO(), instanceRef)
...
func TestGetMigInstances(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			instances, err := provider.GetMigInstances(context.TODO(), mig.GceRef())
			cachedInstances, cached := tc.cache.GetMigInstances(context.TODO(), mig.GceRef())
			refreshTime, refreshed := tc.cache.GetMigInstancesUpdateTime(context.TODO(), mig.GceRef())
...
func TestRegenerateMigInstancesCache(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := provider.RegenerateMigInstancesCache(context.TODO())
...
func TestGetMigTargetSize(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			targetSize, err := provider.GetMigTargetSize(context.TODO(), tc.migQuery.GceRef())
			cachedTargetSize, found := tc.cache.GetMigTargetSize(context.TODO(), tc.migQuery.GceRef())
...
func TestGetMigTargetSize_Optimization(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			size, err := provider.GetMigTargetSize(context.TODO(), mig.GceRef())
...
func TestRefreshMigInfo(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := provider.RefreshMigInfo(context.TODO(), tc.migQuery.GceRef())
			assert.Equal(t, tc.expectedErr, err)
...
func TestGetMigBasename(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			basename, err := provider.GetMigBasename(context.TODO(), mig.GceRef())
...
func TestGetListManagedInstancesResults(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			results, err := provider.GetListManagedInstancesResults(context.TODO(), mig.GceRef())
...
func TestGetMigInstanceTemplateName(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			instanceTemplateName, err := provider.GetMigInstanceTemplateName(context.TODO(), mig.GceRef())
			cachedInstanceTemplateName, found := tc.cache.GetMigInstanceTemplateName(context.TODO(), mig.GceRef())
...
func TestGetMigInstanceTemplate(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			template, err := provider.GetMigInstanceTemplate(context.TODO(), mig.GceRef())
			cachedTemplate, found := tc.cache.GetMigInstanceTemplate(context.TODO(), mig.GceRef())
...
func TestGetMigInstanceKubeEnv(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			kubeEnv, err := provider.GetMigKubeEnv(context.TODO(), mig.GceRef())
			cachedKubeEnv, found := tc.cache.GetMigKubeEnv(context.TODO(), mig.GceRef())
...
func TestGetMigMachineType(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			machine, err := provider.GetMigMachineType(context.TODO(), mig.GceRef())
			if tc.expectError {
				assert.Error(t, err)
			} else {
				assert.NoError(t, err)
...
func TestMultipleFillMigInstancesCallsLimited(t *testing.T) {
	...
	for name, tc := range map[string]struct {
		...
		t.Run(name, func(t *testing.T) {
			...
			err := provider.fillMigInstances(context.TODO(), mig.GceRef())
			assert.NoError(t, err)
...
func TestListInstancesInAllZonesWithMigs(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			instances, err := provider.listInstancesInAllZonesWithMigs(context.TODO())
...
func TestUpdateMigInstancesCache(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := provider.updateMigInstancesCache(context.TODO(), tc.migToInstances)
			assert.NoError(t, err)
			for migRef, want := range tc.wantInstances {
				instances, found := cache.GetMigInstances(context.TODO(), migRef)
				assert.True(t, found)
