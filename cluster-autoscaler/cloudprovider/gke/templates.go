...
func (t *GkeTemplateBuilder) GetAcceleratorCount(accelerators []*gce_api.AcceleratorConfig) int64 {
	count := int64(0)
...
func (t *GkeTemplateBuilder) BuildCapacity(machineType string, accelerators []*gce_api.AcceleratorConfig, zone string, cpu int64, mem int64) (apiv1.ResourceList, error) {
...
func (t *GkeTemplateBuilder) BuildAllocatableFromKubeEnv(capacity apiv1.ResourceList, kubeEnv string) (apiv1.ResourceList, error) {
...
func (t *GkeTemplateBuilder) GetAllocatable(capacity, reserved apiv1.ResourceList) apiv1.ResourceList {
...
func (t *GkeTemplateBuilder) BuildNodeFromTemplate(mig gce.Mig, template *gce_api.InstanceTemplate, cpu int64, mem int64) (*apiv1.Node, error) {
...
func buildGenericLabels(ref gce.GceRef, machineType string, nodeName string) (map[string]string, error) {
