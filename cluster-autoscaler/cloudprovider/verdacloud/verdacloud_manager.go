...
func (m *VerdacloudManager) allASGActiveInstances(asg *Asg) ([]verda.Instance, error) {
	if asg.Name == "" {
...
func (m *VerdacloudManager) GetAsgNodes(asg *Asg) ([]string, error) {
	instances, err := m.allASGActiveInstances(asg)
	if err != nil {
		return nil, err
	}
...
func (m *VerdacloudManager) getAsgTemplate(asgRef AsgRef) (*asgTemplate, error) {
