...
type NodeGroupTemplateNodeInfoResponse struct {
	...
	// resourceSliceBytes is an optional list of proto-serialized resource.k8s.io/v1 ResourceSlice objects.
	// Generated by calling v1.ResourceSlice#Marshal().
	// Convertable to a ResourceSlice by calling v1.ResourceSlice#Unmarshal().
	ResourceSliceBytes [][]byte `protobuf:"bytes,3,rep,name=resourceSliceBytes,proto3" json:"resourceSliceBytes,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *NodeGroupTemplateNodeInfoResponse) GetResourceSliceBytes() [][]byte {
	if x != nil {
		return x.ResourceSliceBytes
	}
	return nil
}
...
type NodeGroupAutoscalingOptions struct {
	...
	// MaxNodeStartupDuration is the Maximum time CA waits for node to be ready from registered
...
const file_cloudprovider_externalgrpc_protos_externalgrpc_proto_rawDesc = "" +
	"\n" +
	"4cloudprovider/externalgrpc/protos/externalgrpc.proto\x12/clusterautoscaler.cloudprovider.v1.externalgrpc\x1a\x19google/protobuf/any.proto\x1a google/protobuf/descriptor.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\"e\n" +
	"\tNodeGroup\x12\x0e\n" +
	...
	"\x12resourceSliceBytes\x18\x03 \x03(\fR\x12resourceSliceBytes\"\xbf\x05\n" +
