...
// CustomerProfiles provides the API operation methods for making requests to
// Amazon Connect Customer Profiles. See this package's package overview docs
// for details on the service.
//
// CustomerProfiles methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the CustomerProfiles client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *CustomerProfiles {
...
// newRequest creates a new request for a CustomerProfiles operation and runs any
// custom request initialization.
func (c *CustomerProfiles) newRequest(op *request.Operation, params, data interface{}) *request.Request {
