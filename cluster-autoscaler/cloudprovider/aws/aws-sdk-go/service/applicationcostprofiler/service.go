...
// ApplicationCostProfiler provides the API operation methods for making requests to
// AWS Application Cost Profiler. See this package's package overview docs
// for details on the service.
//
// ApplicationCostProfiler methods are safe to use concurrently. It is not safe to
...
const (
	ServiceName = "ApplicationCostProfiler"   // Name of service.
	EndpointsID = "application-cost-profiler" // ID to lookup a service endpoint with.
	ServiceID   = "ApplicationCostProfiler"   // ServiceID is a unique identifier of a specific service.
)

// New creates a new instance of the ApplicationCostProfiler client with a session.
...
// newRequest creates a new request for a ApplicationCostProfiler operation and runs any
// custom request initialization.
func (c *ApplicationCostProfiler) newRequest(op *request.Operation, params, data interface{}) *request.Request {
