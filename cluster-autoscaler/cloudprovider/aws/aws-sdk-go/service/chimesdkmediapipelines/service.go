...
// ChimeSDKMediaPipelines provides the API operation methods for making requests to
// Amazon Chime SDK Media Pipelines. See this package's package overview docs
// for details on the service.
//
// ChimeSDKMediaPipelines methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the ChimeSDKMediaPipelines client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *ChimeSDKMediaPipelines {
	svc := &ChimeSDKMediaPipelines{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a ChimeSDKMediaPipelines operation and runs any
// custom request initialization.
func (c *ChimeSDKMediaPipelines) newRequest(op *request.Operation, params, data interface{}) *request.Request {
