...
// PrometheusService provides the API operation methods for making requests to
// Amazon Prometheus Service. See this package's package overview docs
// for details on the service.
//
// PrometheusService methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the PrometheusService client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *PrometheusService {
...
// newRequest creates a new request for a PrometheusService operation and runs any
// custom request initialization.
func (c *PrometheusService) newRequest(op *request.Operation, params, data interface{}) *request.Request {
