...
// ChimeSDKMeetings provides the API operation methods for making requests to
// Amazon Chime SDK Meetings. See this package's package overview docs
// for details on the service.
//
// ChimeSDKMeetings methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the ChimeSDKMeetings client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *ChimeSDKMeetings {
	svc := &ChimeSDKMeetings{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a ChimeSDKMeetings operation and runs any
// custom request initialization.
func (c *ChimeSDKMeetings) newRequest(op *request.Operation, params, data interface{}) *request.Request {
