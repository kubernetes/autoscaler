...
// Bedrock provides the API operation methods for making requests to
// Amazon Bedrock. See this package's package overview docs
// for details on the service.
//
// Bedrock methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the Bedrock client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *Bedrock {
	svc := &Bedrock{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a Bedrock operation and runs any
// custom request initialization.
func (c *Bedrock) newRequest(op *request.Operation, params, data interface{}) *request.Request {
