...
// RecycleBin provides the API operation methods for making requests to
// Amazon Recycle Bin. See this package's package overview docs
// for details on the service.
//
// RecycleBin methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *RecycleBin {
	svc := &RecycleBin{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a RecycleBin operation and runs any
// custom request initialization.
func (c *RecycleBin) newRequest(op *request.Operation, params, data interface{}) *request.Request {
