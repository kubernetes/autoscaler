...
// ConnectContactLens provides the API operation methods for making requests to
// Amazon Connect Contact Lens. See this package's package overview docs
// for details on the service.
//
// ConnectContactLens methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the ConnectContactLens client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *ConnectContactLens {
...
// newRequest creates a new request for a ConnectContactLens operation and runs any
// custom request initialization.
func (c *ConnectContactLens) newRequest(op *request.Operation, params, data interface{}) *request.Request {
