...
// AppFabric provides the API operation methods for making requests to
// AppFabric. See this package's package overview docs
// for details on the service.
//
// AppFabric methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the AppFabric client with a session.
...
func New(p client.ConfigProvider, cfgs ...*aws.Config) *AppFabric {
	...
	if c.SigningNameDerived || len(c.SigningName) == 0 {
		c.SigningName = "appfabric"
	}
	return newClient(*c.Config, c.Handlers, c.PartitionID, c.Endpoint, c.SigningRegion, c.SigningName, c.ResolvedRegion)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *AppFabric {
	svc := &AppFabric{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a AppFabric operation and runs any
// custom request initialization.
func (c *AppFabric) newRequest(op *request.Operation, params, data interface{}) *request.Request {
