...
// SageMakerFeatureStoreRuntime provides the API operation methods for making requests to
// Amazon SageMaker Feature Store Runtime. See this package's package overview docs
// for details on the service.
//
// SageMakerFeatureStoreRuntime methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *SageMakerFeatureStoreRuntime {
...
// newRequest creates a new request for a SageMakerFeatureStoreRuntime operation and runs any
// custom request initialization.
func (c *SageMakerFeatureStoreRuntime) newRequest(op *request.Operation, params, data interface{}) *request.Request {
