...
// MigrationHubConfig provides the API operation methods for making requests to
// AWS Migration Hub Config. See this package's package overview docs
// for details on the service.
//
// MigrationHubConfig methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *MigrationHubConfig {
...
// newRequest creates a new request for a MigrationHubConfig operation and runs any
// custom request initialization.
func (c *MigrationHubConfig) newRequest(op *request.Operation, params, data interface{}) *request.Request {
