...
// LicenseManagerUserSubscriptions provides the API operation methods for making requests to
// AWS License Manager User Subscriptions. See this package's package overview docs
// for details on the service.
//
// LicenseManagerUserSubscriptions methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the LicenseManagerUserSubscriptions client with a session.
...
func New(p client.ConfigProvider, cfgs ...*aws.Config) *LicenseManagerUserSubscriptions {
	...
	if c.SigningNameDerived || len(c.SigningName) == 0 {
		c.SigningName = "license-manager-user-subscriptions"
	}
	return newClient(*c.Config, c.Handlers, c.PartitionID, c.Endpoint, c.SigningRegion, c.SigningName, c.ResolvedRegion)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *LicenseManagerUserSubscriptions {
...
// newRequest creates a new request for a LicenseManagerUserSubscriptions operation and runs any
// custom request initialization.
func (c *LicenseManagerUserSubscriptions) newRequest(op *request.Operation, params, data interface{}) *request.Request {
