...
// ConnectWisdomService provides the API operation methods for making requests to
// Amazon Connect Wisdom Service. See this package's package overview docs
// for details on the service.
//
// ConnectWisdomService methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the ConnectWisdomService client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *ConnectWisdomService {
...
// newRequest creates a new request for a ConnectWisdomService operation and runs any
// custom request initialization.
func (c *ConnectWisdomService) newRequest(op *request.Operation, params, data interface{}) *request.Request {
