...
// BedrockAgent provides the API operation methods for making requests to
// Agents for Amazon Bedrock. See this package's package overview docs
// for details on the service.
//
// BedrockAgent methods are safe to use concurrently. It is not safe to
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *BedrockAgent {
	svc := &BedrockAgent{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a BedrockAgent operation and runs any
// custom request initialization.
func (c *BedrockAgent) newRequest(op *request.Operation, params, data interface{}) *request.Request {
