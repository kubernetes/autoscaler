...
// B2bi provides the API operation methods for making requests to
// AWS B2B Data Interchange. See this package's package overview docs
// for details on the service.
//
// B2bi methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the B2bi client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *B2bi {
	svc := &B2bi{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a B2bi operation and runs any
// custom request initialization.
func (c *B2bi) newRequest(op *request.Operation, params, data interface{}) *request.Request {
