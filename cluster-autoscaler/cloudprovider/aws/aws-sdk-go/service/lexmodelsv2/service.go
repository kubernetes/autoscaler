...
// LexModelsV2 provides the API operation methods for making requests to
// Amazon Lex Model Building V2. See this package's package overview docs
// for details on the service.
//
// LexModelsV2 methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the LexModelsV2 client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName, resolvedRegion string) *LexModelsV2 {
	svc := &LexModelsV2{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a LexModelsV2 operation and runs any
// custom request initialization.
func (c *LexModelsV2) newRequest(op *request.Operation, params, data interface{}) *request.Request {
