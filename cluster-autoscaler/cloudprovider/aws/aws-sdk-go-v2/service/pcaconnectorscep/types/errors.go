...
// policies attached to your Amazon Web Services Identity and Access Management
// (IAM) principal. It can also happen because of restrictions in place from an
// Amazon Web Services Organizations service control policy (SCP) that affects your
...
// An input validation error occurred. For example, invalid characters in a name
// tag, or an invalid pagination token.
