...
func (c *Client) ListAppAuthorizations(ctx context.Context, params *ListAppAuthorizationsInput, optFns ...func(*Options)) (*ListAppAuthorizationsOutput, error) {
	if params == nil {
		params = &ListAppAuthorizationsInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "ListAppAuthorizations", params, optFns, c.addOperationListAppAuthorizationsMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*ListAppAuthorizationsOutput)
...
func (c *Client) addOperationListAppAuthorizationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListAppAuthorizations(options.Region), middleware.Before); err != nil {
		return err
	}
...
type ListAppAuthorizationsPaginator struct {
	options   ListAppAuthorizationsPaginatorOptions
	client    ListAppAuthorizationsAPIClient
	params    *ListAppAuthorizationsInput
	nextToken *string
	firstPage bool
}
...
func NewListAppAuthorizationsPaginator(client ListAppAuthorizationsAPIClient, params *ListAppAuthorizationsInput, optFns ...func(*ListAppAuthorizationsPaginatorOptions)) *ListAppAuthorizationsPaginator {
	if params == nil {
		params = &ListAppAuthorizationsInput{}
	}
	...
	return &ListAppAuthorizationsPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
...
func (p *ListAppAuthorizationsPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListAppAuthorizationsOutput, error) {
	if !p.HasMorePages() {
