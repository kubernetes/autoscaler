...
func (c *Client) addOperationGetMedicalScribeStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "GetMedicalScribeStream"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetMedicalScribeStream(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opGetMedicalScribeStream(region string) *awsmiddleware.RegisterServiceMetadata {
