...
func (c *Client) UpdateQAppPermissions(ctx context.Context, params *UpdateQAppPermissionsInput, optFns ...func(*Options)) (*UpdateQAppPermissionsOutput, error) {
	if params == nil {
		params = &UpdateQAppPermissionsInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "UpdateQAppPermissions", params, optFns, c.addOperationUpdateQAppPermissionsMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*UpdateQAppPermissionsOutput)
...
func (c *Client) addOperationUpdateQAppPermissionsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addOpUpdateQAppPermissionsValidationMiddleware(stack); err != nil {
		return err
	}
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opUpdateQAppPermissions(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opUpdateQAppPermissions(region string) *awsmiddleware.RegisterServiceMetadata {
