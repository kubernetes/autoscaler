...
func (c *Client) addOperationListCertificateProvidersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "ListCertificateProviders"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListCertificateProviders(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opListCertificateProviders(region string) *awsmiddleware.RegisterServiceMetadata {
