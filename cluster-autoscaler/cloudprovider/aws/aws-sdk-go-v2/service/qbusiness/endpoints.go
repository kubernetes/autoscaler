...
import (
	...
	internalendpoints "k8s.io/autoscaler/cluster-autoscaler/cloudprovider/aws/aws-sdk-go-v2/service/qbusiness/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_QBUSINESS")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "QBusiness", cfg.ConfigSources)
	if found && err == nil {
	...
	if exprVal := params.Region; exprVal != nil {
		...
		if exprVal := awsrulesfn.GetPartition(_Region); exprVal != nil {
			...
			if true == _PartitionResult.SupportsDualStack {
				if _UseFIPS == true {
					if _PartitionResult.SupportsFIPS == true {
						uriString := func() string {
							...
							out.WriteString("https://qbusiness-fips.")
				...
				uriString := func() string {
					var out strings.Builder
					out.WriteString("https://qbusiness.")
					out.WriteString(_Region)
					out.WriteString(".")
					out.WriteString(_PartitionResult.DualStackDnsSuffix)
					return out.String()
