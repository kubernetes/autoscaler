...
func (c *Client) ListIdNamespaces(ctx context.Context, params *ListIdNamespacesInput, optFns ...func(*Options)) (*ListIdNamespacesOutput, error) {
	if params == nil {
		params = &ListIdNamespacesInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "ListIdNamespaces", params, optFns, c.addOperationListIdNamespacesMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*ListIdNamespacesOutput)
...
func (c *Client) addOperationListIdNamespacesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListIdNamespaces(options.Region), middleware.Before); err != nil {
		return err
	}
...
type ListIdNamespacesPaginator struct {
	options   ListIdNamespacesPaginatorOptions
	client    ListIdNamespacesAPIClient
	params    *ListIdNamespacesInput
	nextToken *string
	firstPage bool
}
...
func NewListIdNamespacesPaginator(client ListIdNamespacesAPIClient, params *ListIdNamespacesInput, optFns ...func(*ListIdNamespacesPaginatorOptions)) *ListIdNamespacesPaginator {
	...
	return &ListIdNamespacesPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
...
func (p *ListIdNamespacesPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListIdNamespacesOutput, error) {
	...
	result, err := p.client.ListIdNamespaces(ctx, &params, optFns...)
	if err != nil {
		return nil, err
	}
	p.firstPage = false
...
// ListIdNamespacesAPIClient is a client that implements the ListIdNamespaces
// operation.
...
var _ ListIdNamespacesAPIClient = (*Client)(nil)

func newServiceMetadataMiddleware_opListIdNamespaces(region string) *awsmiddleware.RegisterServiceMetadata {
