...
// copied from service/eventbridge/endpoint_auth_resolver.go
//
// we SHOULD never have to do this again since discussions about formal
// input-based auth are in the works
