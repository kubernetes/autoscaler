...
func (c *Client) GetQueryResultsMonitorTopContributors(ctx context.Context, params *GetQueryResultsMonitorTopContributorsInput, optFns ...func(*Options)) (*GetQueryResultsMonitorTopContributorsOutput, error) {
	if params == nil {
		params = &GetQueryResultsMonitorTopContributorsInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "GetQueryResultsMonitorTopContributors", params, optFns, c.addOperationGetQueryResultsMonitorTopContributorsMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*GetQueryResultsMonitorTopContributorsOutput)
...
func (c *Client) addOperationGetQueryResultsMonitorTopContributorsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addOpGetQueryResultsMonitorTopContributorsValidationMiddleware(stack); err != nil {
		return err
	}
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetQueryResultsMonitorTopContributors(options.Region), middleware.Before); err != nil {
		return err
	}
...
// GetQueryResultsMonitorTopContributorsPaginatorOptions is the paginator options
// for GetQueryResultsMonitorTopContributors
...
// GetQueryResultsMonitorTopContributorsPaginator is a paginator for
// GetQueryResultsMonitorTopContributors
type GetQueryResultsMonitorTopContributorsPaginator struct {
	options   GetQueryResultsMonitorTopContributorsPaginatorOptions
	client    GetQueryResultsMonitorTopContributorsAPIClient
	params    *GetQueryResultsMonitorTopContributorsInput
	nextToken *string
	firstPage bool
}

// NewGetQueryResultsMonitorTopContributorsPaginator returns a new
// GetQueryResultsMonitorTopContributorsPaginator
func NewGetQueryResultsMonitorTopContributorsPaginator(client GetQueryResultsMonitorTopContributorsAPIClient, params *GetQueryResultsMonitorTopContributorsInput, optFns ...func(*GetQueryResultsMonitorTopContributorsPaginatorOptions)) *GetQueryResultsMonitorTopContributorsPaginator {
	if params == nil {
		params = &GetQueryResultsMonitorTopContributorsInput{}
	}
	...
	return &GetQueryResultsMonitorTopContributorsPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
...
func (p *GetQueryResultsMonitorTopContributorsPaginator) HasMorePages() bool {
	return p.firstPage || (p.nextToken != nil && len(*p.nextToken) != 0)
}

// NextPage retrieves the next GetQueryResultsMonitorTopContributors page.
func (p *GetQueryResultsMonitorTopContributorsPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*GetQueryResultsMonitorTopContributorsOutput, error) {
	if !p.HasMorePages() {
	...
	result, err := p.client.GetQueryResultsMonitorTopContributors(ctx, &params, optFns...)
	if err != nil {
		return nil, err
	}
	p.firstPage = false
...
// GetQueryResultsMonitorTopContributorsAPIClient is a client that implements the
// GetQueryResultsMonitorTopContributors operation.
...
var _ GetQueryResultsMonitorTopContributorsAPIClient = (*Client)(nil)

func newServiceMetadataMiddleware_opGetQueryResultsMonitorTopContributors(region string) *awsmiddleware.RegisterServiceMetadata {
