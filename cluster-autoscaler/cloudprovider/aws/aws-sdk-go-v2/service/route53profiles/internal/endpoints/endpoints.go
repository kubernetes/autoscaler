...
// Resolver Route53Profiles endpoint resolver
		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "route53profiles.{region}.api.aws",
			...
			},
			{
				...
				Hostname:          "route53profiles-fips.{region}.amazonaws.com",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "route53profiles-fips.{region}.api.aws",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "route53profiles.{region}.api.amazonwebservices.com.cn",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "route53profiles-fips.{region}.amazonaws.com.cn",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "route53profiles-fips.{region}.api.amazonwebservices.com.cn",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "route53profiles-fips.{region}.amazonaws.eu",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "route53profiles-fips.{region}.c2s.ic.gov",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "route53profiles.{region}.c2s.ic.gov",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
		},
		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "route53profiles-fips.{region}.sc2s.sgov.gov",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
				...
				Hostname:          "route53profiles.{region}.sc2s.sgov.gov",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
		},
		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "route53profiles-fips.{region}.cloud.adc-e.uk",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
		...
		Defaults: map[endpoints.DefaultKey]endpoints.Endpoint{
			{
				...
				Hostname:          "route53profiles-fips.{region}.csp.hci.ic.gov",
				Protocols:         []string{"https"},
				SignatureVersions: []string{"v4"},
			},
			{
