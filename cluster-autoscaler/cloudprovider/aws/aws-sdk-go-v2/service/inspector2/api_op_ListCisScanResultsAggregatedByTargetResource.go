...
func (c *Client) addOperationListCisScanResultsAggregatedByTargetResourceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "ListCisScanResultsAggregatedByTargetResource"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListCisScanResultsAggregatedByTargetResource(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opListCisScanResultsAggregatedByTargetResource(region string) *awsmiddleware.RegisterServiceMetadata {
