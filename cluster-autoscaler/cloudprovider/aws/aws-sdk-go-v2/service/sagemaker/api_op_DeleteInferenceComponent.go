...
func (c *Client) addOperationDeleteInferenceComponentMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeleteInferenceComponent"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteInferenceComponent(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opDeleteInferenceComponent(region string) *awsmiddleware.RegisterServiceMetadata {
