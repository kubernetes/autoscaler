...
func (c *Client) ListAddonInstances(ctx context.Context, params *ListAddonInstancesInput, optFns ...func(*Options)) (*ListAddonInstancesOutput, error) {
	if params == nil {
		params = &ListAddonInstancesInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "ListAddonInstances", params, optFns, c.addOperationListAddonInstancesMiddlewares)
	if err != nil {
		return nil, err
	}
...
func (c *Client) addOperationListAddonInstancesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	err = stack.Serialize.Add(&awsAwsjson10_serializeOpListAddonInstances{}, middleware.After)
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(&awsAwsjson10_deserializeOpListAddonInstances{}, middleware.After)
	if err != nil {
		return err
	}
	if err := addProtocolFinalizerMiddlewares(stack, options, "ListAddonInstances"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListAddonInstances(options.Region), middleware.Before); err != nil {
		return err
	}
...
// ListAddonInstancesPaginatorOptions is the paginator options for
// ListAddonInstances
...
type ListAddonInstancesPaginator struct {
	options   ListAddonInstancesPaginatorOptions
	client    ListAddonInstancesAPIClient
	params    *ListAddonInstancesInput
	nextToken *string
	firstPage bool
}
...
func NewListAddonInstancesPaginator(client ListAddonInstancesAPIClient, params *ListAddonInstancesInput, optFns ...func(*ListAddonInstancesPaginatorOptions)) *ListAddonInstancesPaginator {
	...
	return &ListAddonInstancesPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
...
func (p *ListAddonInstancesPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListAddonInstancesOutput, error) {
	...
	result, err := p.client.ListAddonInstances(ctx, &params, optFns...)
	if err != nil {
		return nil, err
	}
	p.firstPage = false
...
// ListAddonInstancesAPIClient is a client that implements the ListAddonInstances
// operation.
...
var _ ListAddonInstancesAPIClient = (*Client)(nil)

func newServiceMetadataMiddleware_opListAddonInstances(region string) *awsmiddleware.RegisterServiceMetadata {
