...
func (c *Client) addOperationStopAddressListImportJobMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "StopAddressListImportJob"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opStopAddressListImportJob(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opStopAddressListImportJob(region string) *awsmiddleware.RegisterServiceMetadata {
