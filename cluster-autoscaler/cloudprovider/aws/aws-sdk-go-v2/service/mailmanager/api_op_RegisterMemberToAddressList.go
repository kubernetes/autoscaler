...
func (c *Client) addOperationRegisterMemberToAddressListMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opRegisterMemberToAddressList(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opRegisterMemberToAddressList(region string) *awsmiddleware.RegisterServiceMetadata {
