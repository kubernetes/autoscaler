...
func (c *Client) DescribeMetadataModelExportsAsScript(ctx context.Context, params *DescribeMetadataModelExportsAsScriptInput, optFns ...func(*Options)) (*DescribeMetadataModelExportsAsScriptOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMetadataModelExportsAsScript", params, optFns, c.addOperationDescribeMetadataModelExportsAsScriptMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*DescribeMetadataModelExportsAsScriptOutput)
...
// DescribeMetadataModelExportsAsScriptPaginator is a paginator for
// DescribeMetadataModelExportsAsScript
type DescribeMetadataModelExportsAsScriptPaginator struct {
	options   DescribeMetadataModelExportsAsScriptPaginatorOptions
	client    DescribeMetadataModelExportsAsScriptAPIClient
	params    *DescribeMetadataModelExportsAsScriptInput
	nextToken *string
	firstPage bool
}

// NewDescribeMetadataModelExportsAsScriptPaginator returns a new
// DescribeMetadataModelExportsAsScriptPaginator
func NewDescribeMetadataModelExportsAsScriptPaginator(client DescribeMetadataModelExportsAsScriptAPIClient, params *DescribeMetadataModelExportsAsScriptInput, optFns ...func(*DescribeMetadataModelExportsAsScriptPaginatorOptions)) *DescribeMetadataModelExportsAsScriptPaginator {
	if params == nil {
		params = &DescribeMetadataModelExportsAsScriptInput{}
	}
	...
	return &DescribeMetadataModelExportsAsScriptPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
...
func (p *DescribeMetadataModelExportsAsScriptPaginator) HasMorePages() bool {
	return p.firstPage || (p.nextToken != nil && len(*p.nextToken) != 0)
}

// NextPage retrieves the next DescribeMetadataModelExportsAsScript page.
func (p *DescribeMetadataModelExportsAsScriptPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*DescribeMetadataModelExportsAsScriptOutput, error) {
	if !p.HasMorePages() {
