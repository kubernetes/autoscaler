...
func (c *Client) addOperationDeleteDefaultQBusinessApplicationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeleteDefaultQBusinessApplication"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteDefaultQBusinessApplication(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opDeleteDefaultQBusinessApplication(region string) *awsmiddleware.RegisterServiceMetadata {
