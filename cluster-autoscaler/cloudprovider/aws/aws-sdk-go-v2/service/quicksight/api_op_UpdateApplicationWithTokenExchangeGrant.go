...
func (c *Client) addOperationUpdateApplicationWithTokenExchangeGrantMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "UpdateApplicationWithTokenExchangeGrant"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opUpdateApplicationWithTokenExchangeGrant(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opUpdateApplicationWithTokenExchangeGrant(region string) *awsmiddleware.RegisterServiceMetadata {
