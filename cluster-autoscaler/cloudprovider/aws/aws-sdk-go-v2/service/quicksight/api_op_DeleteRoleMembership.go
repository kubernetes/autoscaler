...
func (c *Client) addOperationDeleteRoleMembershipMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeleteRoleMembership"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteRoleMembership(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opDeleteRoleMembership(region string) *awsmiddleware.RegisterServiceMetadata {
