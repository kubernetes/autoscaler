...
func (c *Client) ListLicenseEndpoints(ctx context.Context, params *ListLicenseEndpointsInput, optFns ...func(*Options)) (*ListLicenseEndpointsOutput, error) {
	if params == nil {
		params = &ListLicenseEndpointsInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "ListLicenseEndpoints", params, optFns, c.addOperationListLicenseEndpointsMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*ListLicenseEndpointsOutput)
...
func (c *Client) addOperationListLicenseEndpointsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "ListLicenseEndpoints"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListLicenseEndpoints(options.Region), middleware.Before); err != nil {
		return err
	}
...
type ListLicenseEndpointsPaginator struct {
	options   ListLicenseEndpointsPaginatorOptions
	client    ListLicenseEndpointsAPIClient
	params    *ListLicenseEndpointsInput
	nextToken *string
	firstPage bool
}
...
func NewListLicenseEndpointsPaginator(client ListLicenseEndpointsAPIClient, params *ListLicenseEndpointsInput, optFns ...func(*ListLicenseEndpointsPaginatorOptions)) *ListLicenseEndpointsPaginator {
	if params == nil {
		params = &ListLicenseEndpointsInput{}
	}
	...
	return &ListLicenseEndpointsPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
...
func (p *ListLicenseEndpointsPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListLicenseEndpointsOutput, error) {
	if !p.HasMorePages() {
