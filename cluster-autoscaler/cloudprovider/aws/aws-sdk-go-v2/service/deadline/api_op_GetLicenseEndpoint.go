...
func (c *Client) GetLicenseEndpoint(ctx context.Context, params *GetLicenseEndpointInput, optFns ...func(*Options)) (*GetLicenseEndpointOutput, error) {
	if params == nil {
		params = &GetLicenseEndpointInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "GetLicenseEndpoint", params, optFns, c.addOperationGetLicenseEndpointMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*GetLicenseEndpointOutput)
...
type LicenseEndpointValidWaiter struct {
	client GetLicenseEndpointAPIClient

	options LicenseEndpointValidWaiterOptions
}
...
func NewLicenseEndpointValidWaiter(client GetLicenseEndpointAPIClient, optFns ...func(*LicenseEndpointValidWaiterOptions)) *LicenseEndpointValidWaiter {
	...
	options.MaxDelay = 1140 * time.Second
	options.Retryable = licenseEndpointValidStateRetryable

	for _, fn := range optFns {
		fn(&options)
	}
	return &LicenseEndpointValidWaiter{
		client:  client,
		options: options,
	}
}

// Wait calls the waiter function for LicenseEndpointValid waiter. The maxWaitDur
// is the maximum wait duration the waiter will wait. The maxWaitDur is required
// and must be greater than zero.
func (w *LicenseEndpointValidWaiter) Wait(ctx context.Context, params *GetLicenseEndpointInput, maxWaitDur time.Duration, optFns ...func(*LicenseEndpointValidWaiterOptions)) error {
	_, err := w.WaitForOutput(ctx, params, maxWaitDur, optFns...)
	return err
}

// WaitForOutput calls the waiter function for LicenseEndpointValid waiter and
// returns the output of the successful operation. The maxWaitDur is the maximum
// wait duration the waiter will wait. The maxWaitDur is required and must be
// greater than zero.
func (w *LicenseEndpointValidWaiter) WaitForOutput(ctx context.Context, params *GetLicenseEndpointInput, maxWaitDur time.Duration, optFns ...func(*LicenseEndpointValidWaiterOptions)) (*GetLicenseEndpointOutput, error) {
	if maxWaitDur <= 0 {
	...
	return nil, fmt.Errorf("exceeded max wait time for LicenseEndpointValid waiter")
}
...
// LicenseEndpointDeletedWaiterOptions are waiter options for
...
type LicenseEndpointDeletedWaiter struct {
	...
	options LicenseEndpointDeletedWaiterOptions
}
...
func NewLicenseEndpointDeletedWaiter(client GetLicenseEndpointAPIClient, optFns ...func(*LicenseEndpointDeletedWaiterOptions)) *LicenseEndpointDeletedWaiter {
	options := LicenseEndpointDeletedWaiterOptions{}
	options.MinDelay = 10 * time.Second
	options.MaxDelay = 2340 * time.Second
	options.Retryable = licenseEndpointDeletedStateRetryable
...
// Wait calls the waiter function for LicenseEndpointDeleted waiter. The
// maxWaitDur is the maximum wait duration the waiter will wait. The maxWaitDur is
// required and must be greater than zero.
func (w *LicenseEndpointDeletedWaiter) Wait(ctx context.Context, params *GetLicenseEndpointInput, maxWaitDur time.Duration, optFns ...func(*LicenseEndpointDeletedWaiterOptions)) error {
	_, err := w.WaitForOutput(ctx, params, maxWaitDur, optFns...)
	return err
}

// WaitForOutput calls the waiter function for LicenseEndpointDeleted waiter and
// returns the output of the successful operation. The maxWaitDur is the maximum
// wait duration the waiter will wait. The maxWaitDur is required and must be
// greater than zero.
func (w *LicenseEndpointDeletedWaiter) WaitForOutput(ctx context.Context, params *GetLicenseEndpointInput, maxWaitDur time.Duration, optFns ...func(*LicenseEndpointDeletedWaiterOptions)) (*GetLicenseEndpointOutput, error) {
	if maxWaitDur <= 0 {
		return nil, fmt.Errorf("maximum wait time for waiter must be greater than zero")
	}
	...
	return nil, fmt.Errorf("exceeded max wait time for LicenseEndpointDeleted waiter")
}

func licenseEndpointDeletedStateRetryable(ctx context.Context, input *GetLicenseEndpointInput, output *GetLicenseEndpointOutput, err error) (bool, error) {
