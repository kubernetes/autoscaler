...
func (c *Client) ListAvailableMeteredProducts(ctx context.Context, params *ListAvailableMeteredProductsInput, optFns ...func(*Options)) (*ListAvailableMeteredProductsOutput, error) {
	if params == nil {
		params = &ListAvailableMeteredProductsInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "ListAvailableMeteredProducts", params, optFns, c.addOperationListAvailableMeteredProductsMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*ListAvailableMeteredProductsOutput)
...
// ListAvailableMeteredProductsPaginatorOptions is the paginator options for
...
// ListAvailableMeteredProductsPaginator is a paginator for
// ListAvailableMeteredProducts
type ListAvailableMeteredProductsPaginator struct {
	options   ListAvailableMeteredProductsPaginatorOptions
	client    ListAvailableMeteredProductsAPIClient
	params    *ListAvailableMeteredProductsInput
	nextToken *string
	firstPage bool
}

// NewListAvailableMeteredProductsPaginator returns a new
// ListAvailableMeteredProductsPaginator
func NewListAvailableMeteredProductsPaginator(client ListAvailableMeteredProductsAPIClient, params *ListAvailableMeteredProductsInput, optFns ...func(*ListAvailableMeteredProductsPaginatorOptions)) *ListAvailableMeteredProductsPaginator {
	if params == nil {
		params = &ListAvailableMeteredProductsInput{}
	}
	...
	return &ListAvailableMeteredProductsPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
...
func (p *ListAvailableMeteredProductsPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListAvailableMeteredProductsOutput, error) {
	if !p.HasMorePages() {
	...
	result, err := p.client.ListAvailableMeteredProducts(ctx, &params, optFns...)
	if err != nil {
		return nil, err
	}
	p.firstPage = false
...
type endpointPrefix_opListAvailableMeteredProductsMiddleware struct {
}

func (*endpointPrefix_opListAvailableMeteredProductsMiddleware) ID() string {
	return "EndpointHostPrefix"
}

func (m *endpointPrefix_opListAvailableMeteredProductsMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opListAvailableMeteredProductsMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opListAvailableMeteredProductsMiddleware{}, "ResolveEndpointV2", middleware.After)
}

// ListAvailableMeteredProductsAPIClient is a client that implements the
// ListAvailableMeteredProducts operation.
