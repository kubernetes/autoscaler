...
func (c *Client) addOperationDeletePromptRouterMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeletePromptRouter"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeletePromptRouter(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opDeletePromptRouter(region string) *awsmiddleware.RegisterServiceMetadata {
