...
import (
	...
	internalendpoints "k8s.io/autoscaler/cluster-autoscaler/cloudprovider/aws/aws-sdk-go-v2/service/iotsecuretunneling/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_IOTSECURETUNNELING")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "IoTSecureTunneling", cfg.ConfigSources)
	if found && err == nil {
						...
						if true == _PartitionResult.SupportsDualStack {
							if "aws" == _PartitionResult.Name {
								uriString := func() string {
									...
									out.WriteString("https://api.iot-tunneling-fips.")
							...
							uriString := func() string {
								var out strings.Builder
								out.WriteString("https://api.tunneling.iot-fips.")
								out.WriteString(_Region)
								out.WriteString(".")
			...
			if _UseDualStack == true {
				if true == _PartitionResult.SupportsDualStack {
					if "aws" == _PartitionResult.Name {
						uriString := func() string {
							var out strings.Builder
							out.WriteString("https://api.iot-tunneling.")
							out.WriteString(_Region)
							out.WriteString(".api.aws")
							return out.String()
						}()
					...
					uriString := func() string {
						var out strings.Builder
						out.WriteString("https://api.tunneling.iot.")
						out.WriteString(_Region)
						out.WriteString(".")
						out.WriteString(_PartitionResult.DualStackDnsSuffix)
						return out.String()
