...
import (
	...
	internalendpoints "k8s.io/autoscaler/cluster-autoscaler/cloudprovider/aws/aws-sdk-go-v2/service/networkmanager/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_NETWORKMANAGER")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "NetworkManager", cfg.ConfigSources)
	if found && err == nil {
	...
	if exprVal := params.Region; exprVal != nil {
		...
		if exprVal := awsrulesfn.GetPartition(_Region); exprVal != nil {
			...
			if _PartitionResult.Name == "aws" {
				if _UseFIPS == false {
					if _UseDualStack == false {
						uriString := "https://networkmanager.us-west-2.amazonaws.com"
			...
			if _PartitionResult.Name == "aws" {
				if _UseFIPS == false {
					if _UseDualStack == true {
						uriString := "https://networkmanager.us-west-2.api.aws"
			...
			if _PartitionResult.Name == "aws" {
				if _UseFIPS == true {
					if _UseDualStack == false {
						uriString := "https://networkmanager-fips.us-west-2.amazonaws.com"
			...
			if _PartitionResult.Name == "aws" {
				if _UseFIPS == true {
					if _UseDualStack == true {
						uriString := "https://networkmanager-fips.us-west-2.api.aws"
			...
			if _PartitionResult.Name == "aws-us-gov" {
				if _UseFIPS == true {
					if _UseDualStack == false {
						uriString := "https://networkmanager.us-gov-west-1.amazonaws.com"
			...
			if _PartitionResult.Name == "aws-us-gov" {
				if _UseFIPS == true {
					if _UseDualStack == true {
						uriString := "https://networkmanager.us-gov-west-1.api.aws"
					...
					if true == _PartitionResult.SupportsFIPS {
						if true == _PartitionResult.SupportsDualStack {
							uriString := func() string {
								...
								out.WriteString("https://networkmanager-fips.")
			...
			if _UseFIPS == false {
				if _UseDualStack == true {
					if true == _PartitionResult.SupportsDualStack {
						uriString := func() string {
							var out strings.Builder
							out.WriteString("https://networkmanager.")
							out.WriteString(_PartitionResult.ImplicitGlobalRegion)
							out.WriteString(".")
							out.WriteString(_PartitionResult.DualStackDnsSuffix)
							return out.String()
