...
func (c *Client) addOperationDeleteWebAuthnCredentialMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeleteWebAuthnCredential"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteWebAuthnCredential(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opDeleteWebAuthnCredential(region string) *awsmiddleware.RegisterServiceMetadata {
