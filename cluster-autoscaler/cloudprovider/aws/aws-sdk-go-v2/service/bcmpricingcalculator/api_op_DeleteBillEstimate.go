...
func (c *Client) addOperationDeleteBillEstimateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeleteBillEstimate"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteBillEstimate(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opDeleteBillEstimate(region string) *awsmiddleware.RegisterServiceMetadata {
