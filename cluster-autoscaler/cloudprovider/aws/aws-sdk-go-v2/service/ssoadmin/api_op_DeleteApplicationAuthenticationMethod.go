...
func (c *Client) addOperationDeleteApplicationAuthenticationMethodMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteApplicationAuthenticationMethod(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opDeleteApplicationAuthenticationMethod(region string) *awsmiddleware.RegisterServiceMetadata {
