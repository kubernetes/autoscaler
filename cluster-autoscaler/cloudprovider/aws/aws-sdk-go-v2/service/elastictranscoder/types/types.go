...
type AudioParameters struct {
	...
	// tracks.
	//
	// The outputs of OneChannelPerTrack for a specific channel value and inputs are
	// as follows:
	//
	//   - 0 channels with any input: Audio omitted from the output
	//
...
type CreateJobOutput struct {
	...
	//   maximum of 300 embedded captions per file.
	//
	...
	// (Fragmented MP4) or ts (MPEG-TS), SegmentDuration is the target maximum
	// duration of each segment in seconds. For HLSv3 format playlists, each media
	// segment is stored in a separate .ts file. For HLSv4 and Smooth playlists, all
	// media segments for an output are stored in a single file. Each segment is
...
type Job struct {
	...
	// same request. You can create a maximum of 30 outputs per job.
	//
...
type JobOutput struct {
	...
	// (Fragmented MP4) or ts (MPEG-TS), SegmentDuration is the target maximum
	// duration of each segment in seconds. For HLSv3 format playlists, each media
	// segment is stored in a separate .ts file. For HLSv4 , MPEG-DASH , and Smooth
	// playlists, all media segments for an output are stored in a single file. Each
	// segment is approximately the length of the SegmentDuration , though individual
...
type PlayReadyDrm struct {
	...
	// provide.
	//
	// The key ID must be provided in big endian, and Elastic Transcoder converts it
...
type VideoParameters struct {
	...
	// Color spaces are the algorithms used by the computer to store information about
	// how to render color. Bt.601 is the standard for standard definition video,
	// while Bt.709 is the standard for high definition video.
	//
	// Valid values include None , Bt709toBt601 , Bt601toBt709 , and Auto .
	//
	// If you chose Auto for ColorSpaceConversionMode and your output is interlaced,
	// your frame rate is one of 23.97 , 24 , 25 , 29.97 , 50 , or 60 , your
