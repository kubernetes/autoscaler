...
func (c *Client) addOperationPauseContactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "PauseContact"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opPauseContact(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opPauseContact(region string) *awsmiddleware.RegisterServiceMetadata {
