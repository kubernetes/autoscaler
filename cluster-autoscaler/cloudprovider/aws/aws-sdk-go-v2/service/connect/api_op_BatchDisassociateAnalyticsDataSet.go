...
func (c *Client) addOperationBatchDisassociateAnalyticsDataSetMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "BatchDisassociateAnalyticsDataSet"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opBatchDisassociateAnalyticsDataSet(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opBatchDisassociateAnalyticsDataSet(region string) *awsmiddleware.RegisterServiceMetadata {
