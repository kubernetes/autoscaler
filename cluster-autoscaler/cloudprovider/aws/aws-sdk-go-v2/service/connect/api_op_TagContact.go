...
func (c *Client) addOperationTagContactMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "TagContact"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opTagContact(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opTagContact(region string) *awsmiddleware.RegisterServiceMetadata {
