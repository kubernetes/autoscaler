...
func (c *Client) addOperationAssociateUserProficienciesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "AssociateUserProficiencies"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opAssociateUserProficiencies(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opAssociateUserProficiencies(region string) *awsmiddleware.RegisterServiceMetadata {
