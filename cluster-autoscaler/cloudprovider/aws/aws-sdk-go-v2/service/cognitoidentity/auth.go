...
var operationAuthOptions = map[string]func(*AuthResolverParameters) []*smithyauth.Option{
	"GetCredentialsForIdentity": func(params *AuthResolverParameters) []*smithyauth.Option {
		return []*smithyauth.Option{
			{SchemeID: smithyauth.SchemeIDAnonymous},
		}
	},

	"GetId": func(params *AuthResolverParameters) []*smithyauth.Option {
		return []*smithyauth.Option{
			{SchemeID: smithyauth.SchemeIDAnonymous},
		}
	},

	"GetOpenIdToken": func(params *AuthResolverParameters) []*smithyauth.Option {
		return []*smithyauth.Option{
			{SchemeID: smithyauth.SchemeIDAnonymous},
		}
	},

	"UnlinkIdentity": func(params *AuthResolverParameters) []*smithyauth.Option {
		return []*smithyauth.Option{
			{SchemeID: smithyauth.SchemeIDAnonymous},
		}
	},
	...
	return []*smithyauth.Option{
		{
			...
			SignerProperties: func() smithy.Properties {
				...
				smithyhttp.SetSigV4SigningName(&props, "cognito-identity")
