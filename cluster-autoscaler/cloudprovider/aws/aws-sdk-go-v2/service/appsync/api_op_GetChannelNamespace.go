...
func (c *Client) addOperationGetChannelNamespaceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "GetChannelNamespace"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetChannelNamespace(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opGetChannelNamespace(region string) *awsmiddleware.RegisterServiceMetadata {
