...
func (c *Client) UpdateCampaignChannelSubtypeConfig(ctx context.Context, params *UpdateCampaignChannelSubtypeConfigInput, optFns ...func(*Options)) (*UpdateCampaignChannelSubtypeConfigOutput, error) {
	if params == nil {
		params = &UpdateCampaignChannelSubtypeConfigInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "UpdateCampaignChannelSubtypeConfig", params, optFns, c.addOperationUpdateCampaignChannelSubtypeConfigMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*UpdateCampaignChannelSubtypeConfigOutput)
	out.ResultMetadata = metadata
	return out, nil
}

// The request for UpdateCampaignChannelSubtypeConfig API.
type UpdateCampaignChannelSubtypeConfigInput struct {
...
func (c *Client) addOperationUpdateCampaignChannelSubtypeConfigMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opUpdateCampaignChannelSubtypeConfig(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opUpdateCampaignChannelSubtypeConfig(region string) *awsmiddleware.RegisterServiceMetadata {
