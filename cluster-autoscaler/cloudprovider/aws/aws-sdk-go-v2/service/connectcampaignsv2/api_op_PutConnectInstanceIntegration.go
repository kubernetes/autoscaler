...
func (c *Client) addOperationPutConnectInstanceIntegrationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opPutConnectInstanceIntegration(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opPutConnectInstanceIntegration(region string) *awsmiddleware.RegisterServiceMetadata {
