...
func (m *endpointPrefix_opPutLoggingOptionsMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opPutLoggingOptionsMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opPutLoggingOptionsMiddleware{}, "ResolveEndpointV2", middleware.After)
}
