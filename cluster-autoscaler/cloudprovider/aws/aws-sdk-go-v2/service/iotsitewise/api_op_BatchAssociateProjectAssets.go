...
func (m *endpointPrefix_opBatchAssociateProjectAssetsMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opBatchAssociateProjectAssetsMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opBatchAssociateProjectAssetsMiddleware{}, "ResolveEndpointV2", middleware.After)
}
