...
import (
	...
	internalendpoints "k8s.io/autoscaler/cluster-autoscaler/cloudprovider/aws/aws-sdk-go-v2/service/bedrockruntime/internal/endpoints"
...
func (m *ResolveEndpoint) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	...
	if len(awsmiddleware.GetSigningName(ctx)) == 0 {
		...
		if len(signingName) == 0 {
			signingName = "amazonbedrockfrontendservice"
		}
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Bedrock Runtime", cfg.ConfigSources)
	if found && err == nil {
		...
		if exprVal := awsrulesfn.GetPartition(_Region); exprVal != nil {
					...
					if true == _PartitionResult.SupportsFIPS {
						if true == _PartitionResult.SupportsDualStack {
							uriString := func() string {
								...
								out.WriteString("https://bedrock-runtime-fips.")
			...
			if _UseDualStack == true {
				if true == _PartitionResult.SupportsDualStack {
					uriString := func() string {
						var out strings.Builder
						out.WriteString("https://bedrock-runtime.")
						out.WriteString(_Region)
						out.WriteString(".")
						out.WriteString(_PartitionResult.DualStackDnsSuffix)
						return out.String()
