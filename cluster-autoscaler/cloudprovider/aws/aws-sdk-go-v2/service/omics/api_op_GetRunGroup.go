...
func (c *Client) addOperationGetRunGroupMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "GetRunGroup"); err != nil {
...
func (m *endpointPrefix_opGetRunGroupMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
...
func addEndpointPrefix_opGetRunGroupMiddleware(stack *middleware.Stack) error {
	return stack.Finalize.Insert(&endpointPrefix_opGetRunGroupMiddleware{}, "ResolveEndpointV2", middleware.After)
}
