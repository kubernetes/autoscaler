...
// The request or operation exceeds the maximum allowed request rate per Amazon
...
// The request is invalid. Verify the values provided for the request parameters
// are accurate.
