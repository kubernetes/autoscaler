...
func (c *Client) addOperationPutTaxInheritanceMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "PutTaxInheritance"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opPutTaxInheritance(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opPutTaxInheritance(region string) *awsmiddleware.RegisterServiceMetadata {
