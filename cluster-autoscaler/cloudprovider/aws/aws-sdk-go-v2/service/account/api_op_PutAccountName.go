...
func (c *Client) addOperationPutAccountNameMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "PutAccountName"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opPutAccountName(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opPutAccountName(region string) *awsmiddleware.RegisterServiceMetadata {
