...
import (
	...
	internalendpoints "k8s.io/autoscaler/cluster-autoscaler/cloudprovider/aws/aws-sdk-go-v2/service/freetier/internal/endpoints"
...
func (m *ResolveEndpoint) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	...
	if len(awsmiddleware.GetSigningName(ctx)) == 0 {
		...
		if len(signingName) == 0 {
			signingName = "awsfreetierservice"
		}
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_FREETIER")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "FreeTier", cfg.ConfigSources)
	if found && err == nil {
	...
	if exprVal := params.Region; exprVal != nil {
		...
		if exprVal := awsrulesfn.GetPartition(_Region); exprVal != nil {
			...
			if _PartitionResult.Name == "aws" {
				if _UseFIPS == true {
					if _PartitionResult.SupportsFIPS == true {
						uriString := func() string {
							...
							out.WriteString("https://freetier-fips.")
				...
				uriString := "https://freetier.us-east-1.api.aws"
			...
			if true == _PartitionResult.SupportsDualStack {
				...
				if _Region == "aws-cn-global" {
					uriString := "https://freetier.cn-northwest-1.api.amazonwebservices.com.cn"
				...
				uriString := func() string {
					var out strings.Builder
					out.WriteString("https://freetier.")
					out.WriteString(_Region)
					out.WriteString(".")
					out.WriteString(_PartitionResult.DualStackDnsSuffix)
					return out.String()
