...
// don't have the required permissions. This can be caused by insufficient
// permissions in policies attached to your Amazon Web Services Identity and Access
// Management (IAM) principal. It can also happen because of restrictions in place
// from an Amazon Web Services Organizations service control policy (SCP) that
