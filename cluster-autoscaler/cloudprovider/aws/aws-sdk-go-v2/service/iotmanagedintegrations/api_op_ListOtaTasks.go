...
func (c *Client) ListOtaTasks(ctx context.Context, params *ListOtaTasksInput, optFns ...func(*Options)) (*ListOtaTasksOutput, error) {
	if params == nil {
		params = &ListOtaTasksInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "ListOtaTasks", params, optFns, c.addOperationListOtaTasksMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*ListOtaTasksOutput)
...
func (c *Client) addOperationListOtaTasksMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListOtaTasks(options.Region), middleware.Before); err != nil {
		return err
	}
...
type ListOtaTasksPaginator struct {
	options   ListOtaTasksPaginatorOptions
	client    ListOtaTasksAPIClient
	params    *ListOtaTasksInput
	nextToken *string
	firstPage bool
}
...
func (p *ListOtaTasksPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListOtaTasksOutput, error) {
	...
	result, err := p.client.ListOtaTasks(ctx, &params, optFns...)
	if err != nil {
		return nil, err
	}
	p.firstPage = false
...
var _ ListOtaTasksAPIClient = (*Client)(nil)

func newServiceMetadataMiddleware_opListOtaTasks(region string) *awsmiddleware.RegisterServiceMetadata {
