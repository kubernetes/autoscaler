...
func (c *Client) ListAudienceModels(ctx context.Context, params *ListAudienceModelsInput, optFns ...func(*Options)) (*ListAudienceModelsOutput, error) {
	if params == nil {
		params = &ListAudienceModelsInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "ListAudienceModels", params, optFns, c.addOperationListAudienceModelsMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*ListAudienceModelsOutput)
...
type ListAudienceModelsPaginator struct {
	options   ListAudienceModelsPaginatorOptions
	client    ListAudienceModelsAPIClient
	params    *ListAudienceModelsInput
	nextToken *string
	firstPage bool
}
...
func NewListAudienceModelsPaginator(client ListAudienceModelsAPIClient, params *ListAudienceModelsInput, optFns ...func(*ListAudienceModelsPaginatorOptions)) *ListAudienceModelsPaginator {
	...
	return &ListAudienceModelsPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
