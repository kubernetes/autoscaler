...
func (c *Client) GetMLConfiguration(ctx context.Context, params *GetMLConfigurationInput, optFns ...func(*Options)) (*GetMLConfigurationOutput, error) {
	if params == nil {
		params = &GetMLConfigurationInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "GetMLConfiguration", params, optFns, c.addOperationGetMLConfigurationMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*GetMLConfigurationOutput)
	out.ResultMetadata = metadata
	return out, nil
}

type GetMLConfigurationInput struct {
...
func (c *Client) addOperationGetMLConfigurationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addOpGetMLConfigurationValidationMiddleware(stack); err != nil {
		return err
	}
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetMLConfiguration(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opGetMLConfiguration(region string) *awsmiddleware.RegisterServiceMetadata {
