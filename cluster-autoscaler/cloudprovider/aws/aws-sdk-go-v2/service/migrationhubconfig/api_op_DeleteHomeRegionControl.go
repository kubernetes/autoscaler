...
func (c *Client) addOperationDeleteHomeRegionControlMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteHomeRegionControl(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opDeleteHomeRegionControl(region string) *awsmiddleware.RegisterServiceMetadata {
