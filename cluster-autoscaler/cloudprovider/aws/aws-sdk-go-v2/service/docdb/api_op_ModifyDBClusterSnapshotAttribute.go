...
type ModifyDBClusterSnapshotAttributeInput struct {
	...
	// account IDs. To make the manual cluster snapshot restorable by any Amazon Web
	// Services account, set it to all . Do not add the all value for any manual
	// cluster snapshots that contain private information that you don't want to be
	...
	// Web Services account identifiers. To remove authorization for any Amazon Web
	// Services account to copy or restore the cluster snapshot, set it to all . If
