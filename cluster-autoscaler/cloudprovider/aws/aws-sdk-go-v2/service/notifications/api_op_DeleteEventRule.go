...
func (c *Client) addOperationDeleteEventRuleMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeleteEventRule"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeleteEventRule(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opDeleteEventRule(region string) *awsmiddleware.RegisterServiceMetadata {
