...
func (c *Client) AssociateChannel(ctx context.Context, params *AssociateChannelInput, optFns ...func(*Options)) (*AssociateChannelOutput, error) {
	if params == nil {
		params = &AssociateChannelInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "AssociateChannel", params, optFns, c.addOperationAssociateChannelMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*AssociateChannelOutput)
...
func (c *Client) addOperationAssociateChannelMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "AssociateChannel"); err != nil {
	...
	if err = addOpAssociateChannelValidationMiddleware(stack); err != nil {
		return err
	}
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opAssociateChannel(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opAssociateChannel(region string) *awsmiddleware.RegisterServiceMetadata {
