...
func (c *Client) addOperationGetNotificationsAccessForOrganizationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "GetNotificationsAccessForOrganization"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetNotificationsAccessForOrganization(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opGetNotificationsAccessForOrganization(region string) *awsmiddleware.RegisterServiceMetadata {
