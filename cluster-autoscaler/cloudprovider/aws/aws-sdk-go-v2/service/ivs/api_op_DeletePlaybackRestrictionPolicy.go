...
func (c *Client) addOperationDeletePlaybackRestrictionPolicyMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "DeletePlaybackRestrictionPolicy"); err != nil {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opDeletePlaybackRestrictionPolicy(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opDeletePlaybackRestrictionPolicy(region string) *awsmiddleware.RegisterServiceMetadata {
