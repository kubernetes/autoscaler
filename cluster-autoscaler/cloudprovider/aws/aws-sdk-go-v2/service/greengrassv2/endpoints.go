...
import (
	...
	internalendpoints "k8s.io/autoscaler/cluster-autoscaler/cloudprovider/aws/aws-sdk-go-v2/service/greengrassv2/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_GREENGRASSV2")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "GreengrassV2", cfg.ConfigSources)
	if found && err == nil {
...
func (r *resolver) ResolveEndpoint(
	...
	if exprVal := params.Region; exprVal != nil {
		...
		if exprVal := awsrulesfn.GetPartition(_Region); exprVal != nil {
					...
					if true == _PartitionResult.SupportsFIPS {
						if true == _PartitionResult.SupportsDualStack {
							uriString := func() string {
								...
								out.WriteString("https://greengrass-fips.")
			...
			if _Region == "dataplane-us-gov-east-1" {
				uriString := "https://greengrass-ats.iot.us-gov-east-1.amazonaws.com"
			...
			if _Region == "dataplane-us-gov-west-1" {
				uriString := "https://greengrass-ats.iot.us-gov-west-1.amazonaws.com"
