...
func (c *Client) addOperationReverseGeocodeMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opReverseGeocode(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opReverseGeocode(region string) *awsmiddleware.RegisterServiceMetadata {
