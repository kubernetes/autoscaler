...
type UntagResourceInput struct {
	...
	// Array of tag keys (strings) for the tags to be removed. See [Best practices and strategies] in Tagging AWS
	// Resources and Tag Editor for details, including restrictions that apply to tags
	// and "Tag naming limits and requirements"; Amazon IVS has no constraints on tags
