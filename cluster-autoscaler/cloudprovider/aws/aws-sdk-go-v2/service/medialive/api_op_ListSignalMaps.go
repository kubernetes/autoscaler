...
func (c *Client) ListSignalMaps(ctx context.Context, params *ListSignalMapsInput, optFns ...func(*Options)) (*ListSignalMapsOutput, error) {
	if params == nil {
		params = &ListSignalMapsInput{}
	}

	result, metadata, err := c.invokeOperation(ctx, "ListSignalMaps", params, optFns, c.addOperationListSignalMapsMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*ListSignalMapsOutput)
...
func (c *Client) addOperationListSignalMapsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := addProtocolFinalizerMiddlewares(stack, options, "ListSignalMaps"); err != nil {
...
type ListSignalMapsPaginator struct {
	options   ListSignalMapsPaginatorOptions
	client    ListSignalMapsAPIClient
	params    *ListSignalMapsInput
	nextToken *string
	firstPage bool
}
...
func NewListSignalMapsPaginator(client ListSignalMapsAPIClient, params *ListSignalMapsInput, optFns ...func(*ListSignalMapsPaginatorOptions)) *ListSignalMapsPaginator {
	...
	return &ListSignalMapsPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
