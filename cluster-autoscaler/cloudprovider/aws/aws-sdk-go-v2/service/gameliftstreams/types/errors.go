...
// The resource specified in the request was not found. Correct the request before
// you try again.
...
// The request would cause the resource to exceed an allowed service quota.
// Resolve the issue before you try again.
