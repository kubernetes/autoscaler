...
import (
	...
	internalendpoints "k8s.io/autoscaler/cluster-autoscaler/cloudprovider/aws/aws-sdk-go-v2/service/shield/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_SHIELD")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Shield", cfg.ConfigSources)
	if found && err == nil {
	...
	if exprVal := params.Region; exprVal != nil {
		...
		if exprVal := awsrulesfn.GetPartition(_Region); exprVal != nil {
			...
			if _PartitionResult.Name == "aws" {
				if _UseFIPS == false {
					if _UseDualStack == false {
						uriString := "https://shield.us-east-1.amazonaws.com"
								...
								smithyauth.SetAuthOptions(&out, []*smithyauth.Option{
									{
										...
										SignerProperties: func() smithy.Properties {
											...
											smithyhttp.SetSigV4SigningName(&sp, "shield")
											smithyhttp.SetSigV4ASigningName(&sp, "shield")
			...
			if _PartitionResult.Name == "aws" {
				if _UseFIPS == true {
					if _UseDualStack == false {
						uriString := "https://shield-fips.us-east-1.amazonaws.com"
					...
					if true == _PartitionResult.SupportsFIPS {
						if true == _PartitionResult.SupportsDualStack {
							uriString := func() string {
								...
								out.WriteString("https://shield-fips.")
