...
import (
	...
	internalendpoints "k8s.io/autoscaler/cluster-autoscaler/cloudprovider/aws/aws-sdk-go-v2/internal/protocoltest/jsonrpc10querycompatible/internal/endpoints"
...
func (m *ResolveEndpoint) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	...
	if len(awsmiddleware.GetSigningName(ctx)) == 0 {
		...
		if len(signingName) == 0 {
			signingName = "json10querycompatible"
		}
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_JSON10QUERYCOMPATIBLE")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Json10QueryCompatible", cfg.ConfigSources)
	if found && err == nil {
