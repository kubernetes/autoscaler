...
func TestMinMaxTargetSize(t *testing.T) {
	...
	if ng.MinSize(context.TODO()) != 2 {
		t.Errorf("expected min size 2, got %d", ng.MinSize(context.TODO()))
	}
	if ng.MaxSize(context.TODO()) != 10 {
		t.Errorf("expected max size 10, got %d", ng.MaxSize(context.TODO()))
	}
...
func TestDeleteNodes(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			err := ng.DeleteNodes(context.TODO(), tc.nodesToDelete)
