...
func listURL(client *huaweicloudsdk.ServiceClient) string {
...
func serviceURL(client *huaweicloudsdk.ServiceClient, serviceID string) string {
	return client.ServiceURL("services", serviceID)
}

func updateURL(client *huaweicloudsdk.ServiceClient, serviceID string) string {
	return client.ServiceURL("services", serviceID)
}
