...
func ChooseVersion(client *huawei_cloud_sdk_go.ProviderClient, recognized []*Version) (*Version, string, error) {
	...
	var resp response
	_, err := client.Request("GET", client.IdentityBase, &huawei_cloud_sdk_go.RequestOpts{
		JSONResponse: &resp,
		OkCodes:      []int{200, 300},
	})
