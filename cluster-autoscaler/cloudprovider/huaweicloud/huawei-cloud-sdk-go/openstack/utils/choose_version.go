...
func ChooseVersion(client *huaweicloudsdk.ProviderClient, recognized []*Version) (*Version, string, error) {
	...
	var resp response
	_, err := client.Request("GET", client.IdentityBase, &huaweicloudsdk.RequestOpts{
		JSONResponse: &resp,
		OkCodes:      []int{200, 300},
	})
