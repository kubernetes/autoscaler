...
## Overview
The cluster autoscaler for [Huawei ServiceStage](https://www.huaweicloud.com/intl/en-us/product/servicestage.html) works with self-built Kubernetes cluster on [Huaweicloud ECS](https://www.huaweicloud.com/intl/en-us/product/ecs.html) and
...
Note: Do not build your auto scaler image in a Huawei Cloud ECS. Build the image in a machine that has access to the Google Container Registry (GCR).
