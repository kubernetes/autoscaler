...
func (m ChangeComputeGpuMemoryClusterCompartmentDetails) String() string {
...
func (m ChangeComputeGpuMemoryClusterCompartmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
