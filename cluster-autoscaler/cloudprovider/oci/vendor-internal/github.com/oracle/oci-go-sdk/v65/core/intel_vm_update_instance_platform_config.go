...
func (m IntelVmUpdateInstancePlatformConfig) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeIntelVmUpdateInstancePlatformConfig IntelVmUpdateInstancePlatformConfig
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeIntelVmUpdateInstancePlatformConfig
	}{
		"INTEL_VM",
		(MarshalTypeIntelVmUpdateInstancePlatformConfig)(m),
	}
