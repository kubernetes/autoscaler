...
func (request GetEndpointServiceRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetEndpointServiceRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetEndpointServiceRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
