...
// InstanceScreenshotSummary The summary data for an instance screenshot.
type InstanceScreenshotSummary struct {
	...
	// The current state of the screenshot.
...
func (m InstanceScreenshotSummary) String() string {
...
func (m InstanceScreenshotSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
