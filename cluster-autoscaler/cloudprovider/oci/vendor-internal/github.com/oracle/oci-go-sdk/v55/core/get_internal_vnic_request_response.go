...
func (request GetInternalVnicRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetInternalVnicRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetInternalVnicRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
