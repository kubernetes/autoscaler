...
// UpdateInternalDrgAttachmentDetails The request to update an InternalDrgAttachment.
type UpdateInternalDrgAttachmentDetails struct {
...
func (m UpdateInternalDrgAttachmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
