...
func (request UpdateInternalPublicIpRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request UpdateInternalPublicIpRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request UpdateInternalPublicIpRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
