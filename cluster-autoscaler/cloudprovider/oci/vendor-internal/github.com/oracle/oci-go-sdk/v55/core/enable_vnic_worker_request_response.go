...
func (request EnableVnicWorkerRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request EnableVnicWorkerRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request EnableVnicWorkerRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
