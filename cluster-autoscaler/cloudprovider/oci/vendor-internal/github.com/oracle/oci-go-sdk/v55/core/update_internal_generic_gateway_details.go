...
// UpdateInternalGenericGatewayDetails Details to update an internal generic gateway.
type UpdateInternalGenericGatewayDetails struct {
...
func (m UpdateInternalGenericGatewayDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
