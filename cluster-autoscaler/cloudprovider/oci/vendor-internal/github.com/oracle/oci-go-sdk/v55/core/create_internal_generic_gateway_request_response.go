...
func (request CreateInternalGenericGatewayRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CreateInternalGenericGatewayRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CreateInternalGenericGatewayRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
