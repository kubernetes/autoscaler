...
func (request DeleteEndpointServiceRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request DeleteEndpointServiceRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request DeleteEndpointServiceRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
