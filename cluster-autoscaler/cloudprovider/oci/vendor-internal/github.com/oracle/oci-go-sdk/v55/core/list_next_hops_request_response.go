...
func (request ListNextHopsRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request ListNextHopsRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request ListNextHopsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
