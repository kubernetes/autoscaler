...
func (request UpdateInternalVnicRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request UpdateInternalVnicRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request UpdateInternalVnicRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
