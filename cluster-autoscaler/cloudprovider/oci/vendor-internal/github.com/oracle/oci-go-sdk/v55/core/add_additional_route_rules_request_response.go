...
func (request AddAdditionalRouteRulesRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request AddAdditionalRouteRulesRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request AddAdditionalRouteRulesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
