...
func (request MigrateDrgRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request MigrateDrgRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request MigrateDrgRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
