...
func (request GenerateLocalPeeringTokenRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GenerateLocalPeeringTokenRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GenerateLocalPeeringTokenRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
