...
func (request GetInternalGenericGatewayByGatewayIdRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetInternalGenericGatewayByGatewayIdRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetInternalGenericGatewayByGatewayIdRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
