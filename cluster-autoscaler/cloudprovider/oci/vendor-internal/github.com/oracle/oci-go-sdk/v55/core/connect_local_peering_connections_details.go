...
type ConnectLocalPeeringConnectionsDetails struct {
	...
	// The OCID (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the other local peering connection.
...
func (m ConnectLocalPeeringConnectionsDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
