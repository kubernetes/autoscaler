...
func (request UpdateEndpointServiceRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request UpdateEndpointServiceRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request UpdateEndpointServiceRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
