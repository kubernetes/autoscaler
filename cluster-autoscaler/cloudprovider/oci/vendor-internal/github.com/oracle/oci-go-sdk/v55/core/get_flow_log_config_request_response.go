...
func (request GetFlowLogConfigRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetFlowLogConfigRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetFlowLogConfigRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
