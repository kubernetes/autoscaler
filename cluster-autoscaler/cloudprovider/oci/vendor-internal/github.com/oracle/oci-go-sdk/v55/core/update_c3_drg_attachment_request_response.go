...
func (request UpdateC3DrgAttachmentRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request UpdateC3DrgAttachmentRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request UpdateC3DrgAttachmentRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
