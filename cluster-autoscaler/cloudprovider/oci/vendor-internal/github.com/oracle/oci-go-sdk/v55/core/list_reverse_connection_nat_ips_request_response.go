...
func (request ListReverseConnectionNatIpsRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request ListReverseConnectionNatIpsRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request ListReverseConnectionNatIpsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := mappingListReverseConnectionNatIpsSortByEnum[string(request.SortBy)]; !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListReverseConnectionNatIpsSortByEnumStringValues(), ",")))
	}
	if _, ok := mappingListReverseConnectionNatIpsSortOrderEnum[string(request.SortOrder)]; !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListReverseConnectionNatIpsSortOrderEnumStringValues(), ",")))
	}
	if _, ok := mappingReverseConnectionNatIpLifecycleStateEnum[string(request.LifecycleState)]; !ok && request.LifecycleState != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LifecycleState: %s. Supported values are: %s.", request.LifecycleState, strings.Join(GetReverseConnectionNatIpLifecycleStateEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListReverseConnectionNatIpsSortByEnum = map[string]ListReverseConnectionNatIpsSortByEnum{
...
func GetListReverseConnectionNatIpsSortByEnumValues() []ListReverseConnectionNatIpsSortByEnum {
	...
	for _, v := range mappingListReverseConnectionNatIpsSortByEnum {
		values = append(values, v)
	}
	return values
}

// GetListReverseConnectionNatIpsSortByEnumStringValues Enumerates the set of values in String for ListReverseConnectionNatIpsSortByEnum
func GetListReverseConnectionNatIpsSortByEnumStringValues() []string {
	return []string{
		"TIMECREATED",
		"DISPLAYNAME",
	}
...
var mappingListReverseConnectionNatIpsSortOrderEnum = map[string]ListReverseConnectionNatIpsSortOrderEnum{
...
func GetListReverseConnectionNatIpsSortOrderEnumValues() []ListReverseConnectionNatIpsSortOrderEnum {
	...
	for _, v := range mappingListReverseConnectionNatIpsSortOrderEnum {
		values = append(values, v)
	}
	return values
}

// GetListReverseConnectionNatIpsSortOrderEnumStringValues Enumerates the set of values in String for ListReverseConnectionNatIpsSortOrderEnum
func GetListReverseConnectionNatIpsSortOrderEnumStringValues() []string {
	return []string{
		"ASC",
		"DESC",
	}
