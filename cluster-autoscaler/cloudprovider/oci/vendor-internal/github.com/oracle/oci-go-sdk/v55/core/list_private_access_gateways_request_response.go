...
func (request ListPrivateAccessGatewaysRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request ListPrivateAccessGatewaysRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request ListPrivateAccessGatewaysRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := mappingListPrivateAccessGatewaysSortByEnum[string(request.SortBy)]; !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListPrivateAccessGatewaysSortByEnumStringValues(), ",")))
	}
	if _, ok := mappingListPrivateAccessGatewaysSortOrderEnum[string(request.SortOrder)]; !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListPrivateAccessGatewaysSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListPrivateAccessGatewaysSortByEnum = map[string]ListPrivateAccessGatewaysSortByEnum{
...
func GetListPrivateAccessGatewaysSortByEnumValues() []ListPrivateAccessGatewaysSortByEnum {
	...
	for _, v := range mappingListPrivateAccessGatewaysSortByEnum {
		values = append(values, v)
	}
	return values
}

// GetListPrivateAccessGatewaysSortByEnumStringValues Enumerates the set of values in String for ListPrivateAccessGatewaysSortByEnum
func GetListPrivateAccessGatewaysSortByEnumStringValues() []string {
	return []string{
		"TIMECREATED",
		"DISPLAYNAME",
	}
...
var mappingListPrivateAccessGatewaysSortOrderEnum = map[string]ListPrivateAccessGatewaysSortOrderEnum{
...
func GetListPrivateAccessGatewaysSortOrderEnumValues() []ListPrivateAccessGatewaysSortOrderEnum {
	...
	for _, v := range mappingListPrivateAccessGatewaysSortOrderEnum {
		values = append(values, v)
	}
	return values
}

// GetListPrivateAccessGatewaysSortOrderEnumStringValues Enumerates the set of values in String for ListPrivateAccessGatewaysSortOrderEnum
func GetListPrivateAccessGatewaysSortOrderEnumStringValues() []string {
	return []string{
		"ASC",
		"DESC",
	}
