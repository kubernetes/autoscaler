...
func (request GetInternalPublicIpRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetInternalPublicIpRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetInternalPublicIpRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
