...
func (request GetLocalPeeringConnectionRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetLocalPeeringConnectionRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetLocalPeeringConnectionRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
