...
func (request DeleteReverseConnectionNatIpRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request DeleteReverseConnectionNatIpRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request DeleteReverseConnectionNatIpRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
