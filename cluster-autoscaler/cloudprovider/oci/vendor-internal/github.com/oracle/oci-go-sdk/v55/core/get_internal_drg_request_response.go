...
func (request GetInternalDrgRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetInternalDrgRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetInternalDrgRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
