...
func (request AcceptLocalPeeringTokenRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request AcceptLocalPeeringTokenRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request AcceptLocalPeeringTokenRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
