...
func (request GetPrivateAccessGatewayRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetPrivateAccessGatewayRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetPrivateAccessGatewayRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
