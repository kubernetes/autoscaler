...
func (request UpdateInternalDnsRecordRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request UpdateInternalDnsRecordRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request UpdateInternalDnsRecordRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
