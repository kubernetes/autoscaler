...
func (request ListLocalPeeringConnectionsRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request ListLocalPeeringConnectionsRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request ListLocalPeeringConnectionsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
