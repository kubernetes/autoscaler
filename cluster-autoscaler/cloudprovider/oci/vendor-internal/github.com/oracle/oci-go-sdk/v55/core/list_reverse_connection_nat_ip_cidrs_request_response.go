...
func (request ListReverseConnectionNatIpCidrsRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request ListReverseConnectionNatIpCidrsRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request ListReverseConnectionNatIpCidrsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
