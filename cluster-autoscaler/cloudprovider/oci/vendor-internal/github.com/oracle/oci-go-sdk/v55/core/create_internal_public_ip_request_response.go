...
func (request CreateInternalPublicIpRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CreateInternalPublicIpRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CreateInternalPublicIpRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
