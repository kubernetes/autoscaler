...
func (request GetC3DrgRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetC3DrgRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetC3DrgRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
