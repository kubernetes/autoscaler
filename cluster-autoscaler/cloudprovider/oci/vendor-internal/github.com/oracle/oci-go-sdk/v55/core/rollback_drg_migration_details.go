...
// RollbackDrgMigrationDetails Request object to Drg Migration API
type RollbackDrgMigrationDetails struct {

	// The size of migration batch.
	BatchSize *int `mandatory:"true" json:"batchSize"`

	// The OCID (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) DRG to migrate.
...
func (m RollbackDrgMigrationDetails) String() string {
...
func (m RollbackDrgMigrationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
