...
func (request UpdateFlowLogConfigAttachmentRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request UpdateFlowLogConfigAttachmentRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request UpdateFlowLogConfigAttachmentRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
