...
func (request CreatePrivateAccessGatewayRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CreatePrivateAccessGatewayRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CreatePrivateAccessGatewayRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
