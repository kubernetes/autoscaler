...
func (request ChangeInternalGenericGatewayCompartmentRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request ChangeInternalGenericGatewayCompartmentRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request ChangeInternalGenericGatewayCompartmentRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
