...
// UpdateInternalPublicIpDetails The data to update internal public IPs
type UpdateInternalPublicIpDetails struct {
	...
	//  entity it is currently assigned to.
	AssignedEntityId *string `mandatory:"false" json:"assignedEntityId"`
}

func (m UpdateInternalPublicIpDetails) String() string {
...
func (m UpdateInternalPublicIpDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
