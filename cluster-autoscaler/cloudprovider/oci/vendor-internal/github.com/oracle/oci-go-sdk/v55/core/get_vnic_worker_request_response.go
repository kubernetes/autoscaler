...
func (request GetVnicWorkerRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetVnicWorkerRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetVnicWorkerRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
