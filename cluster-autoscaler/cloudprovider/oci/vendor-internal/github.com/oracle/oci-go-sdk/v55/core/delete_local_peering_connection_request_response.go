...
func (request DeleteLocalPeeringConnectionRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request DeleteLocalPeeringConnectionRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request DeleteLocalPeeringConnectionRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
