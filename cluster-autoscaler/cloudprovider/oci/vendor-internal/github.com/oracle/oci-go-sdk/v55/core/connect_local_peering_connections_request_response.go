...
func (request ConnectLocalPeeringConnectionsRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request ConnectLocalPeeringConnectionsRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request ConnectLocalPeeringConnectionsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
