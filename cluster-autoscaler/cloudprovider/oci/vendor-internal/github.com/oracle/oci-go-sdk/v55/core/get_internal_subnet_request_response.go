...
func (request GetInternalSubnetRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetInternalSubnetRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetInternalSubnetRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
