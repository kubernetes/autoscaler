...
func (request GetReverseConnectionNatIpRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetReverseConnectionNatIpRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetReverseConnectionNatIpRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
