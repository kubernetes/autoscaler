...
func (request DeleteInternalDnsRecordRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request DeleteInternalDnsRecordRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request DeleteInternalDnsRecordRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
