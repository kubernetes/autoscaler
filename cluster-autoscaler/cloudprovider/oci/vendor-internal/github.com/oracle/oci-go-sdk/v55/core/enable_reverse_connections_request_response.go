...
func (request EnableReverseConnectionsRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request EnableReverseConnectionsRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request EnableReverseConnectionsRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request EnableReverseConnectionsRequest) RetryPolicy() *common.RetryPolicy {
...
func (request EnableReverseConnectionsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// EnableReverseConnectionsResponse wrapper for the EnableReverseConnections operation
type EnableReverseConnectionsResponse struct {
...
func (response EnableReverseConnectionsResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response EnableReverseConnectionsResponse) HTTPResponse() *http.Response {
