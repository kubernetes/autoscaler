...
var mappingListDrgRouteDistributionsSortBy = map[string]ListDrgRouteDistributionsSortByEnum{
...
func GetListDrgRouteDistributionsSortByEnumValues() []ListDrgRouteDistributionsSortByEnum {
	...
	for _, v := range mappingListDrgRouteDistributionsSortBy {
...
var mappingListDrgRouteDistributionsSortOrder = map[string]ListDrgRouteDistributionsSortOrderEnum{
...
func GetListDrgRouteDistributionsSortOrderEnumValues() []ListDrgRouteDistributionsSortOrderEnum {
	...
	for _, v := range mappingListDrgRouteDistributionsSortOrder {
		values = append(values, v)
	}
	return values
}
