...
//
//	mockgen -destination=azure_mock_virtualmachine_client_test.go -package=azure sigs.k8s.io/cloud-provider-azure/pkg/azclient/virtualmachineclient Interface
//
