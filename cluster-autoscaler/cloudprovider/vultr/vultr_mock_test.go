...
type vultrClientMock struct {
	mock.Mock
}

func (v *vultrClientMock) ListNodePools(ctx context.Context, vkeID string, options *govultr.ListOptions) ([]govultr.NodePool, *govultr.Meta, error) {
	args := v.Called(ctx, vkeID, nil)
...
func (v *vultrClientMock) DeleteNodePoolInstance(ctx context.Context, vkeID, nodePoolID, nodeID string) error {
