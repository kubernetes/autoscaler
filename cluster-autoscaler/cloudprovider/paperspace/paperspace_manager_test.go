...
//		cfg := `{"cluster_id": "123456", "token": "123-123-123", "url": "https://api.paperspace.com/v2", "version": "dev"}`
//
//		manager, err := newManager(bytes.NewBufferString(cfg), cloudprovider.NodeGroupDiscoveryOptions{}, nil)
//		assert.NoError(t, err)
//		assert.Equal(t, manager.clusterID, "123456", "cluster ID does not match")
//	})
//
//	t.Run("empty token", func(t *testing.T) {
//		cfg := `{"cluster_id": "123456", "token": "", "url": "https://api.paperspace.com/v2", "version": "dev"}`
//
//		_, err := newManager(bytes.NewBufferString(cfg), cloudprovider.NodeGroupDiscoveryOptions{}, nil)
//		assert.EqualError(t, err, errors.New("access token is not provided").Error())
//	})
//
//	t.Run("empty cluster ID", func(t *testing.T) {
//		cfg := `{"cluster_id": "", "token": "123-123-123", "url": "https://api.paperspace.com/v2", "version": "dev"}`
//
//		_, err := newManager(bytes.NewBufferString(cfg), cloudprovider.NodeGroupDiscoveryOptions{}, nil)
...
//}
//
//func TestPaperspaceManager_Refresh(t *testing.T) {
//	t.Run("success", func(t *testing.T) {
//		cfg := `{"cluster_id": "123456", "token": "123-123-123", "url": "https://api.paperspace.com/v2", "version": "dev"}`
//
//		manager, err := newManager(bytes.NewBufferString(cfg), cloudprovider.NodeGroupDiscoveryOptions{}, nil)
...
//}
//
//func TestPaperspaceManager_RefreshWithNodeSpec(t *testing.T) {
//	t.Run("success", func(t *testing.T) {
//		cfg := `{"cluster_id": "123456", "token": "123-123-123", "url": "https://api.paperspace.com/v2", "version": "dev"}`
//
//		manager, err := newManager(bytes.NewBufferString(cfg), cloudprovider.NodeGroupDiscoveryOptions{}, nil)
