...
//)
//
//func testCloudProvider(t *testing.T, client *doClientMock) *paperspaceCloudProvider {
...
//}
//
//func TestNewPaperspaceCloudProvider(t *testing.T) {
//	t.Run("success", func(t *testing.T) {
//		_ = testCloudProvider(t, nil)
//	})
//}
//
//func TestPaperspaceCloudProvider_Name(t *testing.T) {
...
//}
//
//func TestPaperspaceCloudProvider_NodeGroups(t *testing.T) {
//	provider := testCloudProvider(t, nil)
//
//	t.Run("success", func(t *testing.T) {
...
//}
//
//func TestPaperspaceCloudProvider_NodeGroupForNode(t *testing.T) {
//	clusterID := "123456"
//
//	t.Run("success", func(t *testing.T) {
//		client := &doClientMock{}
