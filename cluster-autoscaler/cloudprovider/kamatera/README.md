...
| nodegroup \"name\"/poweroff-on-scale-down             | override the global setting for this node group                                                                                                         | no        | global/poweroff-on-scale-down      |
| nodegroup \"name\"/poweroff-on-scale-down-max-servers | maximum number of servers in this node group to power off instead of terminating. After this number is reached, the autoscaler will terminate servers   | no        | 0 (unlimited)                      |
| nodegroup \"name\"/poweron-on-scale-up                | override the global setting for this node group                                                                                                         | no        | global/poweron-on-scale-up         |
