...
func TestScaleUp(t *testing.T) {
	...
	bookedCapacityProvReq.SetConditions([]metav1.Condition{{Type: v1beta1.CapacityAvailable, Status: metav1.ConditionTrue, LastTransitionTime: metav1.Now()}})
	...
	expiredProvReq.SetConditions([]metav1.Condition{{Type: v1beta1.Expired, Status: metav1.ConditionTrue, LastTransitionTime: metav1.Now()}})
