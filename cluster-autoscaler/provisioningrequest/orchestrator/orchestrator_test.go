...
func TestScaleUp(t *testing.T) {
	...
	differentProvReqClass := provreqwrapper.BuildTestProvisioningRequest("ns", "differentProvReqClass", "1", "1", "", int32(5), false, time.Now(), v1beta1.ProvisioningClassGenericScaleUp)
	testCases := []struct {
		name             string
