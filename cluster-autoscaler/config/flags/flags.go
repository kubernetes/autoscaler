...
var (
	...
	maxDeletionCandidateTTL                      = flag.Duration("max-deletion-candidate-ttl", time.Duration(0), "Maximum time a node can be marked as removable before the marking becomes stale. This sets the TTL of Cluster-Autoscaler's state if the Cluste-Autoscaler deployment becomes inactive")
...
func createAutoscalingOptions() config.AutoscalingOptions {
	...
	return config.AutoscalingOptions{
		...
		NodeDeletionCandidateTTL:                     *maxDeletionCandidateTTL,
	}
}
