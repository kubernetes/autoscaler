...
require (
	...
	k8s.io/dynamic-resource-allocation v0.35.1
...
replace k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.35.1

replace k8s.io/sample-controller => k8s.io/sample-controller v0.35.1
