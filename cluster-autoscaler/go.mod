...
replace (
	...
	k8s.io/api => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/api
	k8s.io/apiextensions-apiserver => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/apiextensions-apiserver
	k8s.io/apimachinery => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/apimachinery
	k8s.io/apiserver => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/apiserver
	k8s.io/cli-runtime => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/cli-runtime
	k8s.io/client-go => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/client-go
	k8s.io/cloud-provider => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/cloud-provider
	k8s.io/cluster-bootstrap => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/cluster-bootstrap
	k8s.io/code-generator => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/code-generator
	k8s.io/component-base => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/component-base
	k8s.io/cri-api => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/cri-api
	k8s.io/csi-translation-lib => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/csi-translation-lib
	k8s.io/gengo => k8s.io/gengo v0.0.0-20190116091435-f8a0810f38af
	k8s.io/heapster => k8s.io/heapster v1.2.0-beta.1
	k8s.io/klog => k8s.io/klog v0.3.1
	k8s.io/kube-aggregator => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/kube-aggregator
	k8s.io/kube-controller-manager => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/kube-controller-manager
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20190228160746-b3a7cee44a30
	k8s.io/kube-proxy => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/kube-proxy
	k8s.io/kube-scheduler => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/kube-scheduler
	k8s.io/kubectl => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/kubectl
	k8s.io/kubelet => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/kubelet
	k8s.io/legacy-cloud-providers => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/legacy-cloud-providers
	k8s.io/metrics => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/metrics
	k8s.io/node-api => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/node-api
	k8s.io/repo-infra => k8s.io/repo-infra v0.0.0-20181204233714-00fe14e3d1a3
	k8s.io/sample-apiserver => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/sample-apiserver
	k8s.io/sample-cli-plugin => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/sample-cli-plugin
	k8s.io/sample-controller => /tmp/ca-update-vendor.yA1t/kubernetes/staging/src/k8s.io/sample-controller
...
replace github.com/Paperspace/paperspace-go => /Users/colin/programming/paperspace-go

replace k8s.io/kubernetes => /tmp/ca-update-vendor.yA1t/kubernetes
