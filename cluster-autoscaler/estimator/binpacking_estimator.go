...
func shouldUseFastPath(pods []*apiv1.Pod) bool {
	...
	// Fastpath assumes once it cannot schedule any more pods on a node, the node is full.
	// This assumption is not correct in cases of topology spread constraints and zonal/regional pod anti affinity.
