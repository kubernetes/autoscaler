...
type Estimator interface {
	Estimate([]*apiv1.Pod, *schedulerframework.NodeInfo, cloudprovider.NodeGroup, []EstimationLimit) (int, []*apiv1.Pod)
}
...
type EstimationLimiter interface {
	...
	StartEstimation([]*apiv1.Pod, cloudprovider.NodeGroup, []EstimationLimit)
