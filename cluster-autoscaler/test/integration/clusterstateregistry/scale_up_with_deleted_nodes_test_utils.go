...
func RunTestClusterStateRegistryScaleUpWithDeletedNodes(t *testing.T, nodeGroupForNodeWorksForDeletedNodes, hasInstanceNotImplemented bool) {
	...
	infra.Fakes.CloudProvider.ConfigureNodeGroupForNodeBehavior(nodeGroupForNodeWorksForDeletedNodes)
	infra.Fakes.CloudProvider.ConfigureHasInstanceBehavior(hasInstanceNotImplemented)
