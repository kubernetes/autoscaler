...
// DebuggingSnapshotter is a helper which returns a debugging snapshotter.
func DebuggingSnapshotter(isEnabled bool) debuggingsnapshot.DebuggingSnapshotter {
	return debuggingsnapshot.NewDebuggingSnapshotter(isEnabled)
}
