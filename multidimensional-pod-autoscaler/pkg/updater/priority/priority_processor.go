...
type PriorityProcessor interface {
	GetUpdatePriority(pod *apiv1.Pod, mpa *mpa_types.MultidimPodAutoscaler,
...
func (*defaultPriorityProcessor) GetUpdatePriority(pod *apiv1.Pod, _ *mpa_types.MultidimPodAutoscaler,
	recommendation *vpa_types.RecommendedPodResources) PodPriority {
