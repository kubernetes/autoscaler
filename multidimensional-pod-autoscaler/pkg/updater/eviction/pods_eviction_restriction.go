...
type PodsEvictionRestriction interface {
	...
	Evict(pod *apiv1.Pod, mpa *mpa_types.MultidimPodAutoscaler, eventRecorder record.EventRecorder) error
...
func (e *podsEvictionRestrictionImpl) Evict(podToEvict *apiv1.Pod, mpa *mpa_types.MultidimPodAutoscaler, eventRecorder record.EventRecorder) error {
	...
	eventRecorder.Event(podToEvict, apiv1.EventTypeNormal, "EvictedByMPA",
		"Pod was evicted by MPA Updater to apply resource recommendation.")

	eventRecorder.Event(mpa, apiv1.EventTypeNormal, "EvictedPod",
		"MPA Updater evicted Pod "+podToEvict.Name+" to apply resource recommendation.")
...
// controlled by a single MPA object.
func (f *podsEvictionRestrictionFactoryImpl) NewPodsEvictionRestriction(pods []*apiv1.Pod, mpa *mpa_types.MultidimPodAutoscaler) PodsEvictionRestriction {
