// for updating kubernetes dependencies, use `autoscaler/multidimensional-pod-autoscaler/hack/update-kubernetes-deps-in-e2e.sh`
// for any other update, use standard `go mod` commands

module k8s.io/autoscaler/multidimensional-pod-autoscaler/e2e
...
require (
	...
	k8s.io/autoscaler/multidimensional-pod-autoscaler v0.0.1
...
replace (
	...
	k8s.io/autoscaler => ../../
	k8s.io/autoscaler/multidimensional-pod-autoscaler => ../
	k8s.io/autoscaler/vertical-pod-autoscaler => ../../vertical-pod-autoscaler
