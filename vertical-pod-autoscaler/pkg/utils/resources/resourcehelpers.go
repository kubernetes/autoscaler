...
func ContainerRequestsAndLimits(containerName string, pod *apiv1.Pod) (apiv1.ResourceList, apiv1.ResourceList) {
...
//
// [1] https://github.com/kubernetes/enhancements/tree/master/keps/sig-node/1287-in-place-update-pod-resources
func InitContainerRequestsAndLimits(initContainerName string, pod *apiv1.Pod) (apiv1.ResourceList, apiv1.ResourceList) {
...
func findContainer(containerName string, pod *apiv1.Pod) *apiv1.Container {
...
func findInitContainer(initContainerName string, pod *apiv1.Pod) *apiv1.Container {
