...
func TestResourcesEqual(t *testing.T) {
	resA := apiv1.ResourceList{
		apiv1.ResourceCPU:    resource.MustParse("100m"),
		apiv1.ResourceMemory: resource.MustParse("256Mi"),
	}
	resB := apiv1.ResourceList{
		apiv1.ResourceCPU:    resource.MustParse("100m"),
		apiv1.ResourceMemory: resource.MustParse("256Mi"),
	}
	resC := apiv1.ResourceList{
	...
	tests := []struct {
		name     string
		a        apiv1.ResourceList
		b        apiv1.ResourceList
		expected bool
	}{
		{"Both empty", apiv1.ResourceList{}, apiv1.ResourceList{}, true},
		{"Identical resources", resA, resB, true},
		{"Different values", resA, resC, false},
		{"Different lengths", resA, apiv1.ResourceList{apiv1.ResourceCPU: resource.MustParse("100m")}, false},
		{"Missing key", resA, apiv1.ResourceList{apiv1.ResourceCPU: resource.MustParse("100m"), "disk": resource.MustParse("1Gi")}, false},
	}
