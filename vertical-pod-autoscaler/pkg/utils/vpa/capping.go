...
func getBoundaryRecommendation(recommendation apiv1.ResourceList, container apiv1.Container,
	...
	boundaryCpu := GetBoundaryRequestCPU(container.Resources.Requests.Cpu(), container.Resources.Limits.Cpu(), boundaryLimit.Cpu(), defaultLimit.Cpu())
	boundaryMem := GetBoundaryRequestMem(container.Resources.Requests.Memory(), container.Resources.Limits.Memory(), boundaryLimit.Memory(), defaultLimit.Memory())
	return apiv1.ResourceList{
