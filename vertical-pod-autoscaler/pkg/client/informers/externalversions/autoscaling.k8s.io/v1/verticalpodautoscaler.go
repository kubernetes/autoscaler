...
type VerticalPodAutoscalerIndexInformer cache.TypedSharedIndexInformer[*apisautoscalingk8siov1.VerticalPodAutoscaler]

// VerticalPodAutoscalerHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for VerticalPodAutoscaler.
type VerticalPodAutoscalerHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apisautoscalingk8siov1.VerticalPodAutoscaler]
...
type VerticalPodAutoscalerDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apisautoscalingk8siov1.VerticalPodAutoscaler]
...
type VerticalPodAutoscalerFilteringHandler = cache.TypedFilteringResourceEventHandler[*apisautoscalingk8siov1.VerticalPodAutoscaler]

// VerticalPodAutoscalerIndexers is a specialization of [cache.TypedIndexers] for VerticalPodAutoscaler.
type VerticalPodAutoscalerIndexers = cache.TypedIndexers[*apisautoscalingk8siov1.VerticalPodAutoscaler]

// DeletedVerticalPodAutoscaler is a specialization of [cache.DeletedObject] for VerticalPodAutoscaler.
type DeletedVerticalPodAutoscaler = cache.DeletedObject[*apisautoscalingk8siov1.VerticalPodAutoscaler]
...
func NewTypedVerticalPodAutoscalerInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) VerticalPodAutoscalerIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apisautoscalingk8siov1.VerticalPodAutoscaler](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AutoscalingV1().VerticalPodAutoscalers(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AutoscalingV1().VerticalPodAutoscalers(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AutoscalingV1().VerticalPodAutoscalers(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AutoscalingV1().VerticalPodAutoscalers(namespace).Watch(ctx, opts)
			},
		}, client),
...
func (f *verticalPodAutoscalerInformer) TypedInformer() VerticalPodAutoscalerIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apisautoscalingk8siov1.VerticalPodAutoscaler](f.factory.InformerFor(&apisautoscalingk8siov1.VerticalPodAutoscaler{}, f.defaultInformer))
}
...
func (a *verticalPodAutoscalerTypedInformerAdapter) TypedInformer() VerticalPodAutoscalerIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apisautoscalingk8siov1.VerticalPodAutoscaler](a.Informer())
}
...
func ToVerticalPodAutoscalerIndexInformer(informer cache.SharedIndexInformer) VerticalPodAutoscalerIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apisautoscalingk8siov1.VerticalPodAutoscaler](informer)
}
