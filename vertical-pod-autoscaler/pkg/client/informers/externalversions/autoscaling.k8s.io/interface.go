...
import (
	vpaautoscalingv1 "k8s.io/autoscaler/vertical-pod-autoscaler/pkg/client/informers/externalversions/autoscaling.k8s.io/v1"
...
// V1 returns a new vpaautoscalingv1.Interface.
func (g *group) V1() vpaautoscalingv1.Interface {
	return vpaautoscalingv1.New(g.factory, g.namespace, g.tweakListOptions)
}
