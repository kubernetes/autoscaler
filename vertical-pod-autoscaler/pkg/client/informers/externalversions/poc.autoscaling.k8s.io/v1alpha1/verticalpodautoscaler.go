...
type VerticalPodAutoscalerIndexInformer cache.TypedSharedIndexInformer[*apispocautoscalingk8siov1alpha1.VerticalPodAutoscaler]

// VerticalPodAutoscalerHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for VerticalPodAutoscaler.
type VerticalPodAutoscalerHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apispocautoscalingk8siov1alpha1.VerticalPodAutoscaler]
...
type VerticalPodAutoscalerDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apispocautoscalingk8siov1alpha1.VerticalPodAutoscaler]
...
type VerticalPodAutoscalerFilteringHandler = cache.TypedFilteringResourceEventHandler[*apispocautoscalingk8siov1alpha1.VerticalPodAutoscaler]

// VerticalPodAutoscalerIndexers is a specialization of [cache.TypedIndexers] for VerticalPodAutoscaler.
type VerticalPodAutoscalerIndexers = cache.TypedIndexers[*apispocautoscalingk8siov1alpha1.VerticalPodAutoscaler]

// DeletedVerticalPodAutoscaler is a specialization of [cache.DeletedObject] for VerticalPodAutoscaler.
type DeletedVerticalPodAutoscaler = cache.DeletedObject[*apispocautoscalingk8siov1alpha1.VerticalPodAutoscaler]
...
func NewTypedVerticalPodAutoscalerInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) VerticalPodAutoscalerIndexInformer {
	gvr := schema.GroupVersionResource{Group: "poc.autoscaling.k8s.io", Version: "v1alpha1", Resource: "verticalpodautoscalers"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apispocautoscalingk8siov1alpha1.VerticalPodAutoscaler](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.PocV1alpha1().VerticalPodAutoscalers(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.PocV1alpha1().VerticalPodAutoscalers(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.PocV1alpha1().VerticalPodAutoscalers(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.PocV1alpha1().VerticalPodAutoscalers(namespace).Watch(ctx, opts)
			},
		}, client),
...
func (f *verticalPodAutoscalerInformer) TypedInformer() VerticalPodAutoscalerIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apispocautoscalingk8siov1alpha1.VerticalPodAutoscaler](f.factory.InformerFor(&apispocautoscalingk8siov1alpha1.VerticalPodAutoscaler{}, f.defaultInformer))
}
...
func (a *verticalPodAutoscalerTypedInformerAdapter) TypedInformer() VerticalPodAutoscalerIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apispocautoscalingk8siov1alpha1.VerticalPodAutoscaler](a.Informer())
}
...
func ToVerticalPodAutoscalerIndexInformer(informer cache.SharedIndexInformer) VerticalPodAutoscalerIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apispocautoscalingk8siov1alpha1.VerticalPodAutoscaler](informer)
}
