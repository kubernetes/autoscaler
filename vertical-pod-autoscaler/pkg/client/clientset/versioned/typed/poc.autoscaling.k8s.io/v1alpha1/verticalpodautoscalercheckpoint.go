...
type VerticalPodAutoscalerCheckpointInterface interface {
	Create(ctx context.Context, verticalPodAutoscalerCheckpoint *pocautoscalingk8siov1alpha1.VerticalPodAutoscalerCheckpoint, opts metav1.CreateOptions) (*pocautoscalingk8siov1alpha1.VerticalPodAutoscalerCheckpoint, error)
	Update(ctx context.Context, verticalPodAutoscalerCheckpoint *pocautoscalingk8siov1alpha1.VerticalPodAutoscalerCheckpoint, opts metav1.UpdateOptions) (*pocautoscalingk8siov1alpha1.VerticalPodAutoscalerCheckpoint, error)
	Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error
	Get(ctx context.Context, name string, opts metav1.GetOptions) (*pocautoscalingk8siov1alpha1.VerticalPodAutoscalerCheckpoint, error)
	List(ctx context.Context, opts metav1.ListOptions) (*pocautoscalingk8siov1alpha1.VerticalPodAutoscalerCheckpointList, error)
	Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *pocautoscalingk8siov1alpha1.VerticalPodAutoscalerCheckpoint, err error)
