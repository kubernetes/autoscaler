...
type VerticalPodAutoscalerCheckpointInterface interface {
	...
	Apply(ctx context.Context, verticalPodAutoscalerCheckpoint *applyconfigurationautoscalingk8siov1beta1.VerticalPodAutoscalerCheckpointApplyConfiguration, opts v1.ApplyOptions) (result *autoscalingk8siov1beta1.VerticalPodAutoscalerCheckpoint, err error)
...
type verticalPodAutoscalerCheckpoints struct {
	*gentype.ClientWithListAndApply[*autoscalingk8siov1beta1.VerticalPodAutoscalerCheckpoint, *autoscalingk8siov1beta1.VerticalPodAutoscalerCheckpointList, *applyconfigurationautoscalingk8siov1beta1.VerticalPodAutoscalerCheckpointApplyConfiguration]
}
...
func newVerticalPodAutoscalerCheckpoints(c *AutoscalingV1beta1Client, namespace string) *verticalPodAutoscalerCheckpoints {
	return &verticalPodAutoscalerCheckpoints{
		gentype.NewClientWithListAndApply[*autoscalingk8siov1beta1.VerticalPodAutoscalerCheckpoint, *autoscalingk8siov1beta1.VerticalPodAutoscalerCheckpointList, *applyconfigurationautoscalingk8siov1beta1.VerticalPodAutoscalerCheckpointApplyConfiguration](
