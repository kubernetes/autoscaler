...
import (
	...
	applyconfigurationautoscalingk8siov1beta1 "k8s.io/autoscaler/vertical-pod-autoscaler/pkg/client/applyconfiguration/autoscaling.k8s.io/v1beta1"
...
type VerticalPodAutoscalerInterface interface {
	...
	Apply(ctx context.Context, verticalPodAutoscaler *applyconfigurationautoscalingk8siov1beta1.VerticalPodAutoscalerApplyConfiguration, opts v1.ApplyOptions) (result *autoscalingk8siov1beta1.VerticalPodAutoscaler, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, verticalPodAutoscaler *applyconfigurationautoscalingk8siov1beta1.VerticalPodAutoscalerApplyConfiguration, opts v1.ApplyOptions) (result *autoscalingk8siov1beta1.VerticalPodAutoscaler, err error)
...
type verticalPodAutoscalers struct {
	*gentype.ClientWithListAndApply[*autoscalingk8siov1beta1.VerticalPodAutoscaler, *autoscalingk8siov1beta1.VerticalPodAutoscalerList, *applyconfigurationautoscalingk8siov1beta1.VerticalPodAutoscalerApplyConfiguration]
}
...
func newVerticalPodAutoscalers(c *AutoscalingV1beta1Client, namespace string) *verticalPodAutoscalers {
	return &verticalPodAutoscalers{
		gentype.NewClientWithListAndApply[*autoscalingk8siov1beta1.VerticalPodAutoscaler, *autoscalingk8siov1beta1.VerticalPodAutoscalerList, *applyconfigurationautoscalingk8siov1beta1.VerticalPodAutoscalerApplyConfiguration](
