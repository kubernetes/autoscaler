...
type VerticalPodAutoscalerCheckpointInterface interface {
	...
	Apply(ctx context.Context, verticalPodAutoscalerCheckpoint *applyconfigurationautoscalingk8siov1beta2.VerticalPodAutoscalerCheckpointApplyConfiguration, opts v1.ApplyOptions) (result *autoscalingk8siov1beta2.VerticalPodAutoscalerCheckpoint, err error)
...
type verticalPodAutoscalerCheckpoints struct {
	*gentype.ClientWithListAndApply[*autoscalingk8siov1beta2.VerticalPodAutoscalerCheckpoint, *autoscalingk8siov1beta2.VerticalPodAutoscalerCheckpointList, *applyconfigurationautoscalingk8siov1beta2.VerticalPodAutoscalerCheckpointApplyConfiguration]
}
...
func newVerticalPodAutoscalerCheckpoints(c *AutoscalingV1beta2Client, namespace string) *verticalPodAutoscalerCheckpoints {
	return &verticalPodAutoscalerCheckpoints{
		gentype.NewClientWithListAndApply[*autoscalingk8siov1beta2.VerticalPodAutoscalerCheckpoint, *autoscalingk8siov1beta2.VerticalPodAutoscalerCheckpointList, *applyconfigurationautoscalingk8siov1beta2.VerticalPodAutoscalerCheckpointApplyConfiguration](
