...
type VerticalPodAutoscalerInterface interface {
	...
	Apply(ctx context.Context, verticalPodAutoscaler *applyconfigurationautoscalingk8siov1.VerticalPodAutoscalerApplyConfiguration, opts metav1.ApplyOptions) (result *autoscalingk8siov1.VerticalPodAutoscaler, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, verticalPodAutoscaler *applyconfigurationautoscalingk8siov1.VerticalPodAutoscalerApplyConfiguration, opts metav1.ApplyOptions) (result *autoscalingk8siov1.VerticalPodAutoscaler, err error)
...
type verticalPodAutoscalers struct {
	*gentype.ClientWithListAndApply[*autoscalingk8siov1.VerticalPodAutoscaler, *autoscalingk8siov1.VerticalPodAutoscalerList, *applyconfigurationautoscalingk8siov1.VerticalPodAutoscalerApplyConfiguration]
}
...
func newVerticalPodAutoscalers(c *AutoscalingV1Client, namespace string) *verticalPodAutoscalers {
	return &verticalPodAutoscalers{
		gentype.NewClientWithListAndApply[*autoscalingk8siov1.VerticalPodAutoscaler, *autoscalingk8siov1.VerticalPodAutoscalerList, *applyconfigurationautoscalingk8siov1.VerticalPodAutoscalerApplyConfiguration](
