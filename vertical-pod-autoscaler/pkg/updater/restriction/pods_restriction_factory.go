...
func NewPodsRestrictionFactory(client kube_client.Interface, minReplicas int,
	evictionToleranceFraction float64, clock clock.Clock, lastInPlaceAttemptTimeMap map[string]time.Time, patchCalculators []patch.Calculator) (PodsRestrictionFactory, error) {
	...
	return &PodsRestrictionFactoryImpl{
		...
		clock:                     clock,
		lastInPlaceAttemptTimeMap: lastInPlaceAttemptTimeMap,
