...
// Copied from https://github.com/kubernetes/kubernetes/blob/c180d6762d7ac5059d9b50457cafb0d7f4cf74a9/pkg/generated/openapi/cmd/models-schema/main.go
...
func main() {
	err := output()
	if err != nil {
		os.Stderr.WriteString(fmt.Sprintf("Failed: %v", err)) // nolint:errcheck,staticcheck
		os.Exit(1)
	}
}
