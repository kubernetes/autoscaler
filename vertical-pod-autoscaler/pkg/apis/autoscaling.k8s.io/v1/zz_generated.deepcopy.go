...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemoryPeakCheckpoint) DeepCopyInto(out *MemoryPeakCheckpoint) {
	*out = *in
	in.WindowEnd.DeepCopyInto(&out.WindowEnd)
	in.LastSampleStart.DeepCopyInto(&out.LastSampleStart)
	out.Peak = in.Peak.DeepCopy()
	out.OOMPeak = in.OOMPeak.DeepCopy()
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemoryPeakCheckpoint.
func (in *MemoryPeakCheckpoint) DeepCopy() *MemoryPeakCheckpoint {
	if in == nil {
		return nil
	}
	out := new(MemoryPeakCheckpoint)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VerticalPodAutoscalerCheckpointStatus) DeepCopyInto(out *VerticalPodAutoscalerCheckpointStatus) {
	*out = *in
	...
	in.LastSampleStart.DeepCopyInto(&out.LastSampleStart)
	if in.CurrentMemoryPeak != nil {
		in, out := &in.CurrentMemoryPeak, &out.CurrentMemoryPeak
		*out = new(MemoryPeakCheckpoint)
		(*in).DeepCopyInto(*out)
	}
	return
