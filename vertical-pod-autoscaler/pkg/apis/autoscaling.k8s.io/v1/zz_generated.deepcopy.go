...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RecommendedPodResourcesGroup) DeepCopyInto(out *RecommendedPodResourcesGroup) {
	*out = *in
	if in.ContainerRecommendations != nil {
		in, out := &in.ContainerRecommendations, &out.ContainerRecommendations
		*out = make([]RecommendedContainerResources, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RecommendedPodResourcesGroup.
func (in *RecommendedPodResourcesGroup) DeepCopy() *RecommendedPodResourcesGroup {
	if in == nil {
		return nil
	}
	out := new(RecommendedPodResourcesGroup)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VerticalPodAutoscalerStatus) DeepCopyInto(out *VerticalPodAutoscalerStatus) {
	*out = *in
	...
	if in.RecommendationGroups != nil {
		in, out := &in.RecommendationGroups, &out.RecommendationGroups
		*out = make([]RecommendedPodResourcesGroup, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
