...
type ContainerResourcePolicy struct {
	...
	// The (0, 1] range is enforced by CRD validation and the admission webhook.
	// +optional
	// +kubebuilder:validation:XValidation:rule="quantity(self).isGreaterThan(quantity('0')) && !quantity(self).isGreaterThan(quantity('1'))",message="targetCPUPercentile must be in (0, 1]"
	...
	// The (0, 1] range is enforced by CRD validation and the admission webhook.
	// +optional
	// +kubebuilder:validation:XValidation:rule="quantity(self).isGreaterThan(quantity('0')) && !quantity(self).isGreaterThan(quantity('1'))",message="targetMemoryPercentile must be in (0, 1]"
