...
type VerticalPodAutoscaler struct {
	...
	// status is current information about the autoscaler.
	// +optional
...
type VerticalPodAutoscalerSpec struct {
	...
	// updatePolicy dDescribes the rules on how changes are applied to the pods.
...
type ContainerResourcePolicy struct {
	...
	// maxAllowed sSpecifies the maximum amount of resources that will be recommended
...
type VerticalPodAutoscalerStatus struct {
	// recommendation is tThe most recently computed amount of resources recommended by the
...
type RecommendedContainerResources struct {
	...
	// upperBound specifies mMaximum recommended amount of resources.
...
type VerticalPodAutoscalerCheckpointStatus struct {
	...
	// firstSampleStart is a tTimestamp of the fist sample from the histograms.
	...
	// totalSamplesCount number of samples in the histograms.
...
type HistogramCheckpoint struct {
	...
	// bucketWeights is a map from bucket index to bucket weight.
