...
func init() {
	...
	if *minCheckpointsPerRun != 10 { // Default value is 10
		klog.Warningf("The 'min-checkpoints' flag is deprecated and has no effect. It will be removed in a future release.")
	}
}
