...
var (
	...
	oomMinBumpUp                   = flag.Float64("oom-bump-up-ratio", model.DefaultOOMMinBumpUp, `Specifies minimal increase of memory after observing OOM., default is 100 * 1024 * 1024`)
)
