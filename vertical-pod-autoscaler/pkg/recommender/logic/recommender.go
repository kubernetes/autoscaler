...
var (
	...
	humanizeMemory             = flag.Bool("humanize-memory", false, "Convert memory values in recommendations to the highest appropriate SI unit without decimal places for better readability.")
)
