...
func newContainerSpec(pod *corev1.Pod, container corev1.Container, containerType model.ContainerType) BasicContainerSpec {
...
func calculateRequestedResources(pod *corev1.Pod, container corev1.Container) model.Resources {
