...
func (c *verticalPodAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VerticalPodAutoscaler, err error) {
...
func (c *verticalPodAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VerticalPodAutoscalerList, err error) {
...
func (c *verticalPodAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *verticalPodAutoscalers) Create(ctx context.Context, verticalPodAutoscaler *v1alpha1.VerticalPodAutoscaler, opts v1.CreateOptions) (result *v1alpha1.VerticalPodAutoscaler, err error) {
	result = &v1alpha1.VerticalPodAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("verticalpodautoscalers").
...
func (c *verticalPodAutoscalers) Update(ctx context.Context, verticalPodAutoscaler *v1alpha1.VerticalPodAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.VerticalPodAutoscaler, err error) {
	result = &v1alpha1.VerticalPodAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("verticalpodautoscalers").
...
func (c *verticalPodAutoscalers) UpdateStatus(ctx context.Context, verticalPodAutoscaler *v1alpha1.VerticalPodAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.VerticalPodAutoscaler, err error) {
	result = &v1alpha1.VerticalPodAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("verticalpodautoscalers").
...
func (c *verticalPodAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *verticalPodAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *verticalPodAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VerticalPodAutoscaler, err error) {
	result = &v1alpha1.VerticalPodAutoscaler{}
