...
func gatherTestSuiteMetrics() error {
	...
	grabber, err := e2emetrics.NewMetricsGrabber(c, nil, nil, !framework.ProviderIs("kubemark"), true, true, true, framework.TestContext.IncludeClusterAutoscalerMetrics, false)
	if err != nil {
