...
To view the most recent _release_ of flags for all VPA components, consult the release tag [flags(1.7.2)](https://github.com/kubernetes/autoscaler/blob/vertical-pod-autoscaler-1.7.2/vertical-pod-autoscaler/docs/flags.md) documentation.
