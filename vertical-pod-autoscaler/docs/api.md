...
| `podLabelSelector` _[LabelSelector](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#labelselector-v1-meta)_ | PodLabelSelector allows selecting pods directly by label selector, instead of using TargetRef.<br />If specified, pods matching this selector will be managed by the VPA.<br />If both TargetRef and PodLabelSelector are specified, PodLabelSelector takes precedence. |  |  |
