...
git ls-files --full-name \
    ...
    | grep -v cluster-autoscaler/cloudprovider/bizflycloud/gobizfly \
    | grep -v cluster-autoscaler/cloudprovider/oci/vendor-internal \
    | grep -E -v 'cluster-autoscaler/cloudprovider/brightbox/(go-cache|gobrightbox|k8ssdk|linkheader)' \
