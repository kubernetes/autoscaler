...
func (_m *PricingModel) NodePrice(ctx context.Context, node *v1.Node, startTime time.Time, endTime time.Time) (float64, error) {
...
func (_m *PricingModel) PodPrice(ctx context.Context, pod *v1.Pod, startTime time.Time, endTime time.Time) (float64, error) {
