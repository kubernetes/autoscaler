...
func TestRegisterFailedScaleUpDirectCall(t *testing.T) {
	...
	producer.RegisterFailedScaleUp(context.Background(), nodeGroup, 3, errorInfo, now)
...
func TestRegisterFailedScaleUpCallViaObserversList(t *testing.T) {
	...
	list.RegisterFailedScaleUp(context.Background(), nodeGroup, 5, errorInfo, now)
...
func TestRegisterScaleUpDirectCall(t *testing.T) {
	...
	nodeGroup := provider.GetNodeGroup("ng1")
	producer.RegisterScaleUp(context.Background(), nodeGroup, 2, now)
...
func TestRegisterScaleUpCallViaObserversList(t *testing.T) {
	...
	nodeGroup := provider.GetNodeGroup("ng2")
	list.RegisterScaleUp(context.Background(), nodeGroup, 4, now)
...
func TestRegisterScaleUpUsesNodeInfoRegistry(t *testing.T) {
	...
	nodeGroup := provider.GetNodeGroup("ng1")
	producer.RegisterScaleUp(context.Background(), nodeGroup, 1, now)
