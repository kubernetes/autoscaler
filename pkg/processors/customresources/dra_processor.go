...
func getNodeInfo(ctx context.Context, autoscalingCtx *ca_context.AutoscalingContext, ng cloudprovider.NodeGroup) (*framework.NodeInfo, error) {
	...
	return ng.TemplateNodeInfo(ctx)
}
