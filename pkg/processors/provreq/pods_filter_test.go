...
func TestProvisioningRequestPodsFilter(t *testing.T) {
	...
	for _, test := range testCases {
		...
		got, _ := filter.Process(context.Background(), autoscalingCtx, test.unschedulableCandidates)
...
func TestEventManager(t *testing.T) {
	...
	got, err := prFilter.Process(context.Background(), autoscalingCtx, unscheduledPods)
