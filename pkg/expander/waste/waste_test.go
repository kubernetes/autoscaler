...
func TestLeastWaste(t *testing.T) {
	...
	ret := e.BestOptions(context.Background(), []expander.Option{balancedOption}, nodeMap)
	...
	ret = e.BestOptions(context.Background(), []expander.Option{balancedOption, highmemOption}, nodeMap)
	assert.Equal(t, ret, []expander.Option{balancedOption})
	...
	ret = e.BestOptions(context.Background(), []expander.Option{balancedOption, highmemOption, lowcpuOption}, nodeMap)
