...
import (
	...
	"sigs.k8s.io/cluster-autoscaler/pkg/expander/grpcplugin"
	"sigs.k8s.io/cluster-autoscaler/pkg/expander/leastnodes"
	"sigs.k8s.io/cluster-autoscaler/pkg/expander/mostpods"
	"sigs.k8s.io/cluster-autoscaler/pkg/expander/price"
	"sigs.k8s.io/cluster-autoscaler/pkg/expander/priority"
	"sigs.k8s.io/cluster-autoscaler/pkg/expander/random"
	"sigs.k8s.io/cluster-autoscaler/pkg/expander/waste"
...
func (f *Factory) RegisterDefaultExpanders(cloudProvider cloudprovider.CloudProvider, autoscalingKubeClients *ca_context.AutoscalingKubeClients, kubeClient kube_client.Interface, configNamespace string, GRPCExpanderCert string, GRPCExpanderURL string) {
